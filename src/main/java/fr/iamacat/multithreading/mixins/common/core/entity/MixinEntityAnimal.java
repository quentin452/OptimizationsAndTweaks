    ...
    public void onLivingUpdate() {
        ...
        if (this.inLove > 0) {
            ...
            if (this.inLove % 10 == 0) {
                ...
                this.worldObj.spawnParticle(s, this.posX + (double)(multithreadingandtweaks$random.nextFloat() * this.width * 2.0F) - (double)this.width, this.posY + 0.5D + (double)(multithreadingandtweaks$random.nextFloat() * this.height), this.posZ + (double)(multithreadingandtweaks$random.nextFloat() * this.width * 2.0F) - (double)this.width, d0, d1, d2);
            }
        } else {
            this.breeding = 0;
        }
