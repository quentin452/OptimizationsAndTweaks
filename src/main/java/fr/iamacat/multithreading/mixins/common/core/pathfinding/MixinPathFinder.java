...
public class MixinPathFinder {
    ...
    public MixinPathFinder(IBlockAccess p_i2137_1_, boolean p_i2137_2_, boolean p_i2137_3_, boolean p_i2137_4_,
        boolean p_i2137_5_) {
     ...
     */
    @Unique
    public PathEntity2 createEntityPathTo(Entity p_75859_1_, int p_75859_2_, int p_75859_3_, int p_75859_4_,
        float p_75859_5_, CallbackInfo ci) {
        return this.createEntityPathTo(
            p_75859_1_,
            (double) ((float) p_75859_2_ + 0.5F),
            (double) ((float) p_75859_3_ + 0.5F),
            (double) ((float) p_75859_4_ + 0.5F),
            p_75859_5_,
            ci);
    }
     ...
     */
    @Unique
    private PathEntity2 createEntityPathTo(Entity p_75857_1_, double p_75857_2_, double p_75857_4_, double p_75857_6_,
        float p_75857_8_, CallbackInfo ci) {
        this.path.clearPath();
        ...
        if (this.canEntityDrown && p_75857_1_.isInWater()) {
            ...
            for (Block block = this.worldMap
                .getBlock(MathHelper.floor_double(p_75857_1_.posX), i, MathHelper.floor_double(p_75857_1_.posZ)); block
                    == Blocks.flowing_water
                    || block == Blocks.water; block = this.worldMap.getBlock(
                        MathHelper.floor_double(p_75857_1_.posX),
                        i,
        ...
        PathPoint2 pathpoint2 = this.openPoint(
            MathHelper.floor_double(p_75857_1_.boundingBox.minX),
            i,
            MathHelper.floor_double(p_75857_1_.boundingBox.minZ));
        PathPoint2 pathpoint = this.openPoint(
            MathHelper.floor_double(p_75857_2_ - (double) (p_75857_1_.width / 2.0F)),
            MathHelper.floor_double(p_75857_4_),
            MathHelper.floor_double(p_75857_6_ - (double) (p_75857_1_.width / 2.0F)));
        PathPoint2 pathpoint1 = new PathPoint2(
    ...
    public PathEntity2 addToPath(Entity p_75861_1_, PathPoint2 p_75861_2_, PathPoint2 p_75861_3_, PathPoint2 p_75861_4_,
        float p_75861_5_, CallbackInfo ci) {
     ...
     */
    @Unique
    public int findPathOptions(Entity p_75860_1_, PathPoint2 p_75860_2_, PathPoint2 p_75860_3_, PathPoint2 p_75860_4_,
        float p_75860_5_, CallbackInfo ci) {
        int i = 0;
        byte b0 = 0;

        if (this
            .getVerticalOffset(p_75860_1_, p_75860_2_.xCoord, p_75860_2_.yCoord + 1, p_75860_2_.zCoord, p_75860_3_, ci)
            == 1) {
            b0 = 1;
        }

        PathPoint2 pathpoint3 = this
            .getSafePoint(p_75860_1_, p_75860_2_.xCoord, p_75860_2_.yCoord, p_75860_2_.zCoord + 1, p_75860_3_, b0, ci);
        PathPoint2 pathpoint4 = this
            .getSafePoint(p_75860_1_, p_75860_2_.xCoord - 1, p_75860_2_.yCoord, p_75860_2_.zCoord, p_75860_3_, b0, ci);
        PathPoint2 pathpoint5 = this
            .getSafePoint(p_75860_1_, p_75860_2_.xCoord + 1, p_75860_2_.yCoord, p_75860_2_.zCoord, p_75860_3_, b0, ci);
        PathPoint2 pathpoint6 = this
            .getSafePoint(p_75860_1_, p_75860_2_.xCoord, p_75860_2_.yCoord, p_75860_2_.zCoord - 1, p_75860_3_, b0, ci);
     ...
     */
    @Unique
    private PathPoint2 getSafePoint(Entity p_75858_1_, int p_75858_2_, int p_75858_3_, int p_75858_4_,
        PathPoint2 p_75858_5_, int p_75858_6_, CallbackInfo ci) {
        ...
        if (i1 == 2) {
            ...
            if (pathpoint1 == null && p_75858_6_ > 0
                && i1 != -3
                && i1 != -4
                && this.getVerticalOffset(p_75858_1_, p_75858_2_, p_75858_3_ + p_75858_6_, p_75858_4_, p_75858_5_, ci)
                    == 1) {
    ...
    public int getVerticalOffset(Entity p_75855_1_, int p_75855_2_, int p_75855_3_, int p_75855_4_,
        PathPoint2 p_75855_5_, CallbackInfo ci) {
        return func_82565_a(
            p_75855_1_,
            p_75855_2_,
            p_75855_3_,
    ...
    private static int func_82565_a(Entity p_82565_0_, int p_82565_1_, int p_82565_2_, int p_82565_3_,
        PathPoint2 p_82565_4_, boolean p_82565_5_, boolean p_82565_6_, boolean p_82565_7_, CallbackInfo ci) {
        if (MultithreadingandtweaksConfig.enableMixinPathFinding) {
            boolean flag3 = false;
                ...
                for (int i1 = p_82565_2_; i1 < p_82565_2_ + p_82565_4_.yCoord; ++i1) {
                    for (int j1 = p_82565_3_; j1 < p_82565_3_ + p_82565_4_.zCoord; ++j1) {
                        ...
                        if (block.getMaterial() != Material.air) {
                            ...
                            if (p_82565_0_.worldObj.getBlock(l, i1, j1)
                                .getRenderType() == 9) {
                                ...
                                if (p_82565_0_.worldObj.getBlock(j2, l1, i2)
                                    .getRenderType() != 9
                                    && p_82565_0_.worldObj.getBlock(j2, l1 - 1, i2)
                                        .getRenderType() != 9) {
                                    return -3;
                                }
