  ...
  /*  @Unique
    public void generateSurface(World world, Random rand, int chunkX, int chunkZ) {
        ...
        if (!BiomeDictionary.isBiomeOfType(biome, BiomeDictionary.Type.DEAD)) {
            ...
            int i1;
            int j1;
            if (BiomeDictionary.isBiomeOfType(biome, BiomeDictionary.Type.FOREST) && !BiomeDictionary.isBiomeOfType(biome, BiomeDictionary.Type.COLD) && !BiomeDictionary.isBiomeOfType(biome, BiomeDictionary.Type.SPOOKY) && !BiomeDictionary.isBiomeOfType(biome, BiomeDictionary.Type.MOUNTAIN)) {
            ...
            if (BiomeDictionary.isBiomeOfType(biome, BiomeDictionary.Type.WET) && !BiomeDictionary.isBiomeOfType(biome, BiomeDictionary.Type.PLAINS) && !BiomeDictionary.isBiomeOfType(biome, BiomeDictionary.Type.DRY) || BiomeDictionary.isBiomeOfType(biome, BiomeDictionary.Type.HOT) && !BiomeDictionary.isBiomeOfType(biome, BiomeDictionary.Type.PLAINS) && !BiomeDictionary.isBiomeOfType(biome, BiomeDictionary.Type.DRY)) {
                for(k = 0; k < BlockRegistry.tropicalfruittreeRarity; ++k) {
                    l = rand.nextInt(256);
                    i1 = chunkX + rand.nextInt(16);
                    j1 = chunkZ + rand.nextInt(16);
