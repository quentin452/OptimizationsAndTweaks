...
public class MixinFixPamsTreesCascadingWorldgenLag implements IWorldGenerator {
    ...
    @Unique
    private void generateFruitTrees(World world, Random rand, int chunkX, int chunkZ) {
        ...
        if (!BiomeDictionary.isBiomeOfType(biome, BiomeDictionary.Type.DEAD)) {
            ...
            } else if ((BiomeDictionary.isBiomeOfType(biome, BiomeDictionary.Type.WET) || BiomeDictionary.isBiomeOfType(biome, BiomeDictionary.Type.HOT))
