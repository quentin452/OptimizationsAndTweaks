...
package fr.iamacat.multithreading.utils.apache.commons.math3.distribution;
...
public class KolmogorovSmirnovDistribution implements Serializable {
     ...
     * in [1] and {@link fr.iamacat.multithreading.utils.apache.commons.math3.fraction.BigFraction} (see
     * above).
     *
     * @param d statistic
     * @return the two-sided probability of {@code P(D_n < d)}
