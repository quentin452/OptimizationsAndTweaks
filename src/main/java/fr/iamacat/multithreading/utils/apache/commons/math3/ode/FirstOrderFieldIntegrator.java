...
public interface FirstOrderFieldIntegrator<T extends RealFieldElement<T>> {
     ...
     * fr.iamacat.multithreading.utils.apache.commons.math3.analysis.solvers.FieldBracketingNthOrderBrentSolver}.
     * </p>
     * 
     ...
     *      fr.iamacat.multithreading.utils.apache.commons.math3.analysis.solvers.BracketedRealFieldUnivariateSolver)
     * @see #getEventHandlers()
     * @see #clearEventHandlers()
     */
    void addEventHandler(FieldEventHandler<T> handler, double maxCheckInterval, double convergence,
     ...
     */
    void addEventHandler(FieldEventHandler<T> handler, double maxCheckInterval, double convergence,
        int maxIterationCount, BracketedRealFieldUnivariateSolver<T> solver);
     ...
     *         fr.iamacat.multithreading.utils.apache.commons.math3.ode.events.FieldEventHandler} stops it at some
     *         point.
