...
package fr.iamacat.multithreading.utils.apache.commons.math3.ode.events;
 ...
 *
 * <p>
 * These events are defined as occurring when a <code>g</code>
...
public interface EventHandler {
    ...
    enum Action {
         ...
         * fr.iamacat.multithreading.utils.apache.commons.math3.ode.FirstOrderDifferentialEquations#computeDerivatives}
         * method).
         * </p>
         */
        RESET_DERIVATIVES,
     ...
     * otherwise {@link fr.iamacat.multithreading.utils.apache.commons.math3.exception.NoBracketingException
     ...
     * fr.iamacat.multithreading.utils.apache.commons.math3.ode.FirstOrderDifferentialEquations
     ...
     * fr.iamacat.multithreading.utils.apache.commons.math3.ode.sampling.StepHandler#handleStep handleStep}
     ...
     * fr.iamacat.multithreading.utils.apache.commons.math3.ode.sampling.StepHandler StepHandler} method {@link
     * fr.iamacat.multithreading.utils.apache.commons.math3.ode.sampling.StepHandler#handleStep(
     * fr.iamacat.multithreading.utils.apache.commons.math3.ode.sampling.StepInterpolator, boolean)
     ...
     * fr.iamacat.multithreading.utils.apache.commons.math3.ode.sampling.StepNormalizer StepNormalizer}
     * does for example), user code called by this method and user
     * code called by step handlers may experience apparently out of order values
     * of the independent time variable. As an example, if the same user object
     * implements both this {@link EventHandler EventHandler} interface and the
     * {@link fr.iamacat.multithreading.utils.apache.commons.math3.ode.sampling.FixedStepHandler FixedStepHandler}
     ...
     * fr.iamacat.multithreading.utils.apache.commons.math3.ode.sampling.StepHandler variable step handlers} and
     * to the size of the fixed step for {@link
     * fr.iamacat.multithreading.utils.apache.commons.math3.ode.sampling.FixedStepHandler fixed step handlers}.
     * </p>
     * 
     * @param t          current value of the independent <i>time</i> variable
     * @param y          array containing the current value of the state vector
