...
import fr.iamacat.multithreading.utils.apache.commons.math3.optimization.BaseOptimizer;
 ...
 * <ul>
 *  <li>{@link fr.iamacat.multithreading.utils.apache.commons.math3.optimization.univariate.UnivariateOptimizer}</li>
 * </ul>
 *
...
public interface BaseUnivariateOptimizer<FUNC extends UnivariateFunction>
     ...
     * @throws fr.iamacat.multithreading.utils.apache.commons.math3.exception.TooManyEvaluationsException
     * if the maximum evaluation count is exceeded.
     * @throws fr.iamacat.multithreading.utils.apache.commons.math3.exception.ConvergenceException if the
     * optimizer detects a convergence problem.
     * @throws IllegalArgumentException if {@code min > max} or the endpoints
     * do not satisfy the requirements specified by the optimizer.
     * @throws fr.iamacat.multithreading.utils.apache.commons.math3.exception.NullArgumentException if any
