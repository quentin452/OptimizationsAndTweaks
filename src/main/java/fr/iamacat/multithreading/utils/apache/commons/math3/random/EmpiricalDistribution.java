...
import fr.iamacat.multithreading.utils.apache.commons.math3.distribution.AbstractRealDistribution;
import fr.iamacat.multithreading.utils.apache.commons.math3.distribution.ConstantRealDistribution;
import fr.iamacat.multithreading.utils.apache.commons.math3.distribution.NormalDistribution;
...
import fr.iamacat.multithreading.utils.apache.commons.math3.stat.descriptive.SummaryStatistics;
...
public class EmpiricalDistribution extends AbstractRealDistribution {
    ...
    protected final fr.iamacat.multithreading.utils.apache.commons.math3.random.RandomDataGenerator randomData;
    ...
    public EmpiricalDistribution(int binCount) {
        this(binCount, new fr.iamacat.multithreading.utils.apache.commons.math3.random.RandomDataGenerator());
    }
    ...
    public EmpiricalDistribution(int binCount, RandomGenerator generator) {
        this(binCount, new fr.iamacat.multithreading.utils.apache.commons.math3.random.RandomDataGenerator(generator));
    }
    ...
    /**
     * Creates a new EmpiricalDistribution with the specified bin count using the
     * provided {@link fr.iamacat.multithreading.utils.apache.commons.math3.random.RandomDataImpl} instance as the source of random data.
     *
     ...
     */
    @Deprecated
    public EmpiricalDistribution(int binCount, fr.iamacat.multithreading.utils.apache.commons.math3.random.RandomDataImpl randomData) {
        this(binCount, randomData.getDelegate());
    }

    /**
     * Creates a new EmpiricalDistribution with default bin count using the
     * provided {@link fr.iamacat.multithreading.utils.apache.commons.math3.random.RandomDataImpl} as the source of random data.
     *
     * @param randomData random data generator (may be null, resulting in default JDK generator)
     * @since 3.0
     ...
     */
    @Deprecated
    public EmpiricalDistribution(fr.iamacat.multithreading.utils.apache.commons.math3.random.RandomDataImpl randomData) {
    ...
    private EmpiricalDistribution(int binCount,
                                  fr.iamacat.multithreading.utils.apache.commons.math3.random.RandomDataGenerator randomData) {
