...
public class TestUtils {
    ...
    /**
     * @see fr.iamacat.multithreading.utils.apache.commons.math3.stat.inference.TTest#homoscedasticT(fr.iamacat.multithreading.utils.apache.commons.math3.stat.descriptive.StatisticalSummary,
     *      fr.iamacat.multithreading.utils.apache.commons.math3.stat.descriptive.StatisticalSummary)
     */
    public static double homoscedasticT(final StatisticalSummary sampleStats1, final StatisticalSummary sampleStats2)
        throws NullArgumentException, NumberIsTooSmallException {
        return T_TEST.homoscedasticT(sampleStats1, sampleStats2);
    }

    /**
     * @see fr.iamacat.multithreading.utils.apache.commons.math3.stat.inference.TTest#homoscedasticTTest(double[],
     *      double[], double)
     */
    public static boolean homoscedasticTTest(final double[] sample1, final double[] sample2, final double alpha)
    ...
    /**
     * @see fr.iamacat.multithreading.utils.apache.commons.math3.stat.inference.TTest#homoscedasticTTest(fr.iamacat.multithreading.utils.apache.commons.math3.stat.descriptive.StatisticalSummary,
     *      fr.iamacat.multithreading.utils.apache.commons.math3.stat.descriptive.StatisticalSummary)
     */
    ...
    /**
     * @see fr.iamacat.multithreading.utils.apache.commons.math3.stat.inference.TTest#t(double,
     *      fr.iamacat.multithreading.utils.apache.commons.math3.stat.descriptive.StatisticalSummary)
     */
    ...
    /**
     * @see fr.iamacat.multithreading.utils.apache.commons.math3.stat.inference.TTest#t(fr.iamacat.multithreading.utils.apache.commons.math3.stat.descriptive.StatisticalSummary,
     *      fr.iamacat.multithreading.utils.apache.commons.math3.stat.descriptive.StatisticalSummary)
     */
    ...
    /**
     * @see fr.iamacat.multithreading.utils.apache.commons.math3.stat.inference.TTest#tTest(double,
     *      fr.iamacat.multithreading.utils.apache.commons.math3.stat.descriptive.StatisticalSummary, double)
     */
    public static boolean tTest(final double mu, final StatisticalSummary sampleStats, final double alpha)
        throws NullArgumentException, NumberIsTooSmallException, OutOfRangeException, MaxCountExceededException {
    ...
    /**
     * @see fr.iamacat.multithreading.utils.apache.commons.math3.stat.inference.TTest#tTest(fr.iamacat.multithreading.utils.apache.commons.math3.stat.descriptive.StatisticalSummary,
     *      fr.iamacat.multithreading.utils.apache.commons.math3.stat.descriptive.StatisticalSummary, double)
     */
    ...
    /**
     * @see fr.iamacat.multithreading.utils.apache.commons.math3.stat.inference.ChiSquareTest#chiSquare(double[],
     *      long[])
     */
    ...
    /**
     * @see fr.iamacat.multithreading.utils.apache.commons.math3.stat.inference.ChiSquareTest#chiSquareTest(double[],
     *      long[], double)
     */
    public static boolean chiSquareTest(final double[] expected, final long[] observed, final double alpha)
        throws NotPositiveException, NotStrictlyPositiveException, DimensionMismatchException, OutOfRangeException,
     ...
     *      long[])
     */
    public static double chiSquareTest(final double[] expected, final long[] observed) throws NotPositiveException,
        NotStrictlyPositiveException, DimensionMismatchException, MaxCountExceededException {
    ...
    public static double chiSquareTest(final long[][] counts)
        throws NullArgumentException, DimensionMismatchException, NotPositiveException, MaxCountExceededException {
        return CHI_SQUARE_TEST.chiSquareTest(counts);
    }

    /**
     * @see fr.iamacat.multithreading.utils.apache.commons.math3.stat.inference.ChiSquareTest#chiSquareDataSetsComparison(long[],
     *      long[])
     *
     * @since 1.2
     */
    ...
    /**
     * @see fr.iamacat.multithreading.utils.apache.commons.math3.stat.inference.ChiSquareTest#chiSquareTestDataSetsComparison(long[],
     *      long[])
     *
     * @since 1.2
     */
    public static double chiSquareTestDataSetsComparison(final long[] observed1, final long[] observed2)
     ...
     * @since 1.2
     */
    public static boolean chiSquareTestDataSetsComparison(final long[] observed1, final long[] observed2,
        final double alpha) throws DimensionMismatchException, NotPositiveException, ZeroException, OutOfRangeException,
        MaxCountExceededException {
    ...
    public static double oneWayAnovaPValue(final Collection<double[]> categoryData)
        throws NullArgumentException, DimensionMismatchException, ConvergenceException, MaxCountExceededException {
     ...
     * @since 3.1
     */
    public static double gTest(final double[] expected, final long[] observed) throws NotPositiveException,
        NotStrictlyPositiveException, DimensionMismatchException, MaxCountExceededException {
    ...
    /**
     * @see fr.iamacat.multithreading.utils.apache.commons.math3.stat.inference.GTest#gDataSetsComparison(long[],
     *      long[])
     * @since 3.1
     */
    ...
    /**
     * @see fr.iamacat.multithreading.utils.apache.commons.math3.stat.inference.GTest#rootLogLikelihoodRatio(long, long,
     *      long, long)
     * @since 3.1
     */
    ...
    /**
     * @see fr.iamacat.multithreading.utils.apache.commons.math3.stat.inference.GTest#gTestDataSetsComparison(long[],
     *      long[])
     * @since 3.1
     */
     ...
     * @since 3.1
     */
    public static boolean gTestDataSetsComparison(final long[] observed1, final long[] observed2, final double alpha)
        throws DimensionMismatchException, NotPositiveException, ZeroException, OutOfRangeException,
        MaxCountExceededException {
        return G_TEST.gTestDataSetsComparison(observed1, observed2, alpha);
    }

    /**
     * @see fr.iamacat.multithreading.utils.apache.commons.math3.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovStatistic(RealDistribution,
     *      double[])
     * @since 3.3
     */
    ...
    /**
     * @see fr.iamacat.multithreading.utils.apache.commons.math3.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovTest(RealDistribution,
     *      double[])
     * @since 3.3
     */
    ...
    /**
     * @see fr.iamacat.multithreading.utils.apache.commons.math3.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovStatistic(double[],
     *      double[])
     * @since 3.3
     */
    ...
    /**
     * @see fr.iamacat.multithreading.utils.apache.commons.math3.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovTest(double[],
     *      double[])
     * @since 3.3
     */
    ...
    /**
     * @see fr.iamacat.multithreading.utils.apache.commons.math3.stat.inference.KolmogorovSmirnovTest#exactP(double,
     *      int, int, boolean)
     * @since 3.3
     */
    ...
    /**
     * @see fr.iamacat.multithreading.utils.apache.commons.math3.stat.inference.KolmogorovSmirnovTest#approximateP(double,
     *      int, int)
     * @since 3.3
     */
    ...
    /**
     * @see fr.iamacat.multithreading.utils.apache.commons.math3.stat.inference.KolmogorovSmirnovTest#monteCarloP(double,
     *      int, int, boolean, int)
     * @since 3.3
     */
