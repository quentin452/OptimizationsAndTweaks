...
public enum Mixin implements IMixin {
    ...
    common_thaumicrevelations_MixinWardenicChargeEvents(Side.COMMON,
        require(TargetedMod.THAUMICREVELATIONS).and(m -> OptimizationsandTweaksConfig.enableMixinWardenicChargeEvents),
