...
public enum Mixin implements IMixin {
    ...
    */
    ...
    client_core_MixinRenderGlobal(Side.CLIENT,
    ...
    common_koto_MixinEntityDarkMiresi(Side.COMMON,
        m -> OptimizationsandTweaksConfig.enableMixinEntityDarkMiresi, "koto.MixinEntityDarkMiresi"),
    ...
    client_core_MixinModelRenderer(Side.CLIENT, avoid(TargetedMod.OPTIFINE).and(m -> OptimizationsandTweaksConfig.enableMixinModelRenderer),
