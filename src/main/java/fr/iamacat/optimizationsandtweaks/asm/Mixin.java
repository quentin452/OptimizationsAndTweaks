...
public enum Mixin implements IMixin {
    ...
    common_core_MixinExplosion(Side.COMMON, m -> OptimizationsandTweaksConfig.enableMixinExplosion,
        "core.MixinExplosion"),
    ...
    common_lotofthings_MixinGenRainbowFlowers(Side.COMMON,
        require(TargetedMod.LOTSOFTHINGS).and(m -> OptimizationsandTweaksConfig.enableMixinGenRainbowFlowers),
        "lotofthings.MixinGenRainbowFlowers"),
    common_lotofthings_MixinLOTGeneration(Side.COMMON,
        require(TargetedMod.LOTSOFTHINGS).and(m -> OptimizationsandTweaksConfig.enableMixinGenRainbowFlowers),
    ...
    common_thecampingmod_MixinWorldGeneratorTheCamping(Side.COMMON,
        require(TargetedMod.THECAMPINGMOD).and(m -> OptimizationsandTweaksConfig.enableMixinWorldGeneratorTheCamping),
    ...
    common_core_MixinTileEntityRendererDispatcher(Side.COMMON,
        m -> OptimizationsandTweaksConfig.enableMixinTileEntityRendererDispatcher,
        "core.MixinTileEntityRendererDispatcher"),
    ...
    common_eternalfrost_mobspawningfix_MixinBlockMobSpawner2(Side.COMMON,
        require(TargetedMod.ETERNALFROST).and(m -> OptimizationsandTweaksConfig.enableEternalFrostMobSpawningFix),
        "eternalfrost.mobspawningfix.MixinBlockMobSpawner2"),
    common_eternalfrost_mobspawningfix_MixinBlockMobSpawner3(Side.COMMON,
        require(TargetedMod.ETERNALFROST).and(m -> OptimizationsandTweaksConfig.enableEternalFrostMobSpawningFix),
        "eternalfrost.mobspawningfix.MixinBlockMobSpawner3"),
    common_eternalfrost_mobspawningfix_MixinVanillaMobSpawnerBaseLogic(Side.COMMON,
        require(TargetedMod.ETERNALFROST).and(m -> OptimizationsandTweaksConfig.enableEternalFrostMobSpawningFix),
    ...
    common_eternalfrost_classcastexceptionfix_MixinTileEntitySnowbarkChestRenderer(Side.COMMON,
        require(TargetedMod.ETERNALFROST)
            .and(m -> OptimizationsandTweaksConfig.enableEternalFrostClassCastExceptionFix),
        "eternalfrost.classcastexceptionfix.MixinTileEntitySnowbarkChestRenderer"),
    ...
    common_spiriteores_MixinSpiritOres(Side.COMMON,
        require(TargetedMod.SPIRITEORES)
            .and(m -> OptimizationsandTweaksConfig.enableCreateConfigurableOresForSpiritOres),
        "spiriteores.MixinSpiritOres"),
    common_spiriteores_MixinSpiritOresGenerator(Side.COMMON,
        require(TargetedMod.SPIRITEORES)
            .and(m -> OptimizationsandTweaksConfig.enableCreateConfigurableOresForSpiritOres),
