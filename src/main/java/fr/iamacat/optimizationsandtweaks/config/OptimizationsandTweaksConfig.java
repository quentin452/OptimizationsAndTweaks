...
public class OptimizationsandTweaksConfig {
    ...
    @Config.Comment("Fix ghost EntityItem generated by onEntityCollidedWithBlock from "
        + "Aura Node from Thaumcraft to prevent lags")
    @Config.DefaultBoolean(true)
    @Config.RequiresWorldRestart
    ...
    @Config.Comment("Fix NULL Crash on startup from the init method of "
        + "DeepslateOreRegistry from Et Futurum Requiem with bad mods installed")
    @Config.DefaultBoolean(true)
    @Config.RequiresWorldRestart
    ...
    @Config.Comment("(todo) Fix " + "https://github.com/quentin452/privates-minecraft-modpack/"
        + "issues/48 with FamiliarsAPI")
    @Config.DefaultBoolean(true)
    @Config.RequiresWorldRestart
    ...
    @Config.Comment("Fix eternalfrost biomes ids are hardcoded at 255(by "
        + "removing it) if endlessids ids is installed")
    @Config.DefaultBoolean(true)
    @Config.RequiresWorldRestart
    ...
    @Config.Comment("Fix AluminumOxideWorldGen Infinite Loop that freeze the server from "
        + "Minenautica mod(Disabled by default cause problem during generation)")
    @Config.DefaultBoolean(false)
    @Config.RequiresWorldRestart
    public static boolean enableMixinAluminumOxideWorldGen;

    @Config.Comment("Fix Cascading worldgens caused by CanBlockStay from Minenautica "
        + "mod(Disabled by default cause problem during generation)")
    @Config.DefaultBoolean(false)
    @Config.RequiresWorldRestart
    public static boolean enableMixinCanBlockStay;
    @Config.Comment("Fix Cascading worldgens caused by BiomeGenKelpForest from Minenautica "
        + "mod(Disabled by default cause problem during generation)")
    @Config.DefaultBoolean(false)
    @Config.RequiresWorldRestart
    public static boolean enableMixinBiomeGenKelpForest;
    @Config.Comment("Fix Cascading worldgens caused by BiomeGenGrassyPlateaus from "
        + "Minenautica mod(Disabled by default cause problem during generation)")
    @Config.DefaultBoolean(false)
    @Config.RequiresWorldRestart
    public static boolean enableMixinBiomeGenGrassyPlateaus;
    @Config.Comment("Fix Cascading worldgens caused by Bloodgrass from Minenautica "
        + "mod(Disabled by default cause problem during generation)")
    @Config.DefaultBoolean(false)
    @Config.RequiresWorldRestart
    public static boolean enableMixinBloodgrass;
    @Config.Comment("Fix Cascading worldgens caused by GenerateCoal from Minenautica "
        + "mod(Disabled by default cause problem during generation)")
    @Config.DefaultBoolean(true)
    @Config.RequiresWorldRestart
    ...
    @Config.Comment("Fix Crash between Endlessids and Lord of the rings mod(but problem "
        + "remain , does not support higher id than the vanilla scope(256)")
    @Config.DefaultBoolean(true)
    @Config.RequiresWorldRestart
    ...
    @Config.Comment("Try to fix Default value cannot be lower than minimum "
        + "value! + Fix Server attempted to spawn an unknown entity "
        + "caused by thread unsafety from NetHandlerPlayClient class")
    @Config.DefaultBoolean(true)
    @Config.RequiresWorldRestart
    ...
    @Config.Comment("Fix Some Cascading Worldgen caused by WorldGenMassiveTree "
        + "class from minefactory reloaded Mod")
    @Config.DefaultBoolean(true)
    @Config.RequiresWorldRestart
    ...
    @Config.Comment("Fix Some Cascading Worldgen caused by "
        + "MineFactoryReloadedWorldGen from minefactory reloaded Mod")
    @Config.DefaultBoolean(true)
    @Config.RequiresWorldRestart
    ...
    @Config.Comment("Fix All Cascading Worldgen caused by Poly Gravel from Shinkeiseikan "
        + "Collection Mod (ATTENTION this mixin disabling Poly Gravel generation)")
    @Config.DefaultBoolean(true)
    @Config.RequiresWorldRestart
    ...
    @Config.Comment("Rewrite MythicAndMonster generator to use RecurrentComplex(need "
        + "recurent complex installed)(The mixin will be injected only if "
        + "Recurrent Complex is installed")
    @Config.DefaultBoolean(true)
    @Config.RequiresWorldRestart
    public static boolean enableMixinMAMWorldGenerator;
    @Config.Comment("Fix EXTREME Cascading Worldgen caused by WorldGenNori "
        + "Class from MasterChef mod(I disabled the generation code "
        + "because it seem that nothing is generated in game and so "
        + "make cascading worldgens for nothing)")
    @Config.DefaultBoolean(true)
    @Config.RequiresWorldRestart
    ...
    @Config.Comment("Fix \"java.lang.NullPointerException: Unexpected error\" caused "
        + "by onKeypress from ClientProxy class from Angelica Mod")
    @Config.DefaultBoolean(true)
    @Config.RequiresWorldRestart
    public static boolean enableMixinClientProxy;

    @Config.Comment("Fixed player-thrown items being incorrectly removed during chunk generation (Tidy Chunk)")
    @Config.DefaultBoolean(true)
    @Config.RequiresWorldRestart
    ...
    @Config.Comment("Fix " + "https://github.com/quentin452/privates-minecraft-modpack/"
        + "issues/905 caused by Tinkersconstruct")
    @Config.DefaultBoolean(true)
    @Config.RequiresWorldRestart
    ...
    @Config.Comment("Remove Grim3212 Version Checker to prevent "
        + "https://github.com/quentin452/privates-minecraft-modpack/issues/903")
    @Config.DefaultBoolean(true)
    @Config.RequiresWorldRestart
    public static boolean enableMixinGrimModule;

    @Config.Comment("Add a cache to DungeonGenerator from Chromaticraft to "
        + "avoid reloading the dungeon every time from file")
    @Config.DefaultBoolean(true)
    @Config.RequiresWorldRestart
    ...
    /*
     * @Config.Comment("List of entities to ignore for entity ticking
     * optimization.")
