...
public class MixinEntityRenderer  implements IResourceManagerReloadListener
{
    ...
    public void setupFog(int p_78468_1_, float p_78468_2_)
    {
        ...
        else
        {
            ...
            net.minecraftforge.client.event.EntityViewRenderEvent.FogDensity event = new net.minecraftforge.client.event.EntityViewRenderEvent.FogDensity(multithreadingandtweaks$entityRenderer, entitylivingbase, block, p_78468_2_, 0.1F);
            ...
            else
            {
                ...
                MinecraftForge.EVENT_BUS.post(new net.minecraftforge.client.event.EntityViewRenderEvent.RenderFogEvent(multithreadingandtweaks$entityRenderer, entitylivingbase, block, p_78468_2_, p_78468_1_, f1));
            }
