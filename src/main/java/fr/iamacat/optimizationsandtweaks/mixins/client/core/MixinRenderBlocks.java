...
public class MixinRenderBlocks {
    ...
    @Unique
    private void optimizationsAndTweaks$renamethismethodlaterPartial(Block p_147808_1_, int p_147808_2_,
        int p_147808_3_, int p_147808_4_, float p_147808_5_, float p_147808_6_, float p_147808_7_,
        int lrenderStandardBlockWithAmbientOcclusionPartial) {
        ...
        this.aoLightValueScratchXYPN = this.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_)
            .getAmbientOcclusionLightValue();
        flag2renderStandardBlockWithAmbientOcclusionPartial = this.blockAccess
            .getBlock(p_147808_2_ + 1, p_147808_3_ - 1, p_147808_4_)
            .getCanBlockGrass();
        flag3renderStandardBlockWithAmbientOcclusionPartial = this.blockAccess
            .getBlock(p_147808_2_ - 1, p_147808_3_ - 1, p_147808_4_)
            .getCanBlockGrass();
        flag4renderStandardBlockWithAmbientOcclusionPartial = this.blockAccess
            .getBlock(p_147808_2_, p_147808_3_ - 1, p_147808_4_ + 1)
            .getCanBlockGrass();
        flag5renderStandardBlockWithAmbientOcclusionPartial = this.blockAccess
            .getBlock(p_147808_2_, p_147808_3_ - 1, p_147808_4_ - 1)
            .getCanBlockGrass();

        if (!flag5renderStandardBlockWithAmbientOcclusionPartial
            && !flag3renderStandardBlockWithAmbientOcclusionPartial) {
            this.aoLightValueScratchXYZNNN = this.aoLightValueScratchXYNN;
            this.aoBrightnessXYZNNN = this.aoBrightnessXYNN;
        } else {
            this.aoLightValueScratchXYZNNN = this.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_ - 1)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZNNN = p_147808_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ - 1, p_147808_3_, p_147808_4_ - 1);
        }

        if (!flag4renderStandardBlockWithAmbientOcclusionPartial
            && !flag3renderStandardBlockWithAmbientOcclusionPartial) {
            this.aoLightValueScratchXYZNNP = this.aoLightValueScratchXYNN;
            this.aoBrightnessXYZNNP = this.aoBrightnessXYNN;
        } else {
            this.aoLightValueScratchXYZNNP = this.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_ + 1)
                .getAmbientOcclusionLightValue();
        ...
        if (!flag5renderStandardBlockWithAmbientOcclusionPartial
            && !flag2renderStandardBlockWithAmbientOcclusionPartial) {
            this.aoLightValueScratchXYZPNN = this.aoLightValueScratchXYPN;
            this.aoBrightnessXYZPNN = this.aoBrightnessXYPN;
        } else {
            this.aoLightValueScratchXYZPNN = this.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_ - 1)
                .getAmbientOcclusionLightValue();
        ...
        if (!flag4renderStandardBlockWithAmbientOcclusionPartial
            ...
            this.aoLightValueScratchXYZPNP = this.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_ + 1)
                .getAmbientOcclusionLightValue();
        ...
        if (this.renderMinY <= 0.0D || !this.blockAccess.getBlock(p_147808_2_, p_147808_3_ - 1, p_147808_4_)
            .isOpaqueCube()) {
            i1renderStandardBlockWithAmbientOcclusionPartial = p_147808_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_ - 1, p_147808_4_);
        }

        f7renderStandardBlockWithAmbientOcclusionPartial = this.blockAccess
            .getBlock(p_147808_2_, p_147808_3_ - 1, p_147808_4_)
            .getAmbientOcclusionLightValue();
        f3renderStandardBlockWithAmbientOcclusionPartial = (this.aoLightValueScratchXYZNNP
            + this.aoLightValueScratchXYNN
            + this.aoLightValueScratchYZNP
            + f7renderStandardBlockWithAmbientOcclusionPartial) / 4.0F;
        f6renderStandardBlockWithAmbientOcclusionPartial = (this.aoLightValueScratchYZNP
            + f7renderStandardBlockWithAmbientOcclusionPartial
            + this.aoLightValueScratchXYZPNP
            + this.aoLightValueScratchXYPN) / 4.0F;
        f5renderStandardBlockWithAmbientOcclusionPartial = (f7renderStandardBlockWithAmbientOcclusionPartial
            + this.aoLightValueScratchYZNN
            + this.aoLightValueScratchXYPN
            + this.aoLightValueScratchXYZPNN) / 4.0F;
        f4renderStandardBlockWithAmbientOcclusionPartial = (this.aoLightValueScratchXYNN
        ...
        this.brightnessTopLeft = this.getAoBrightness(
            ...
            i1renderStandardBlockWithAmbientOcclusionPartial);
        this.brightnessTopRight = this.getAoBrightness(
            this.aoBrightnessYZNP,
            this.aoBrightnessXYZPNP,
            this.aoBrightnessXYPN,
            i1renderStandardBlockWithAmbientOcclusionPartial);
        this.brightnessBottomRight = this.getAoBrightness(
            this.aoBrightnessYZNN,
            this.aoBrightnessXYPN,
            this.aoBrightnessXYZPNN,
            i1renderStandardBlockWithAmbientOcclusionPartial);
        this.brightnessBottomLeft = this.getAoBrightness(
            this.aoBrightnessXYNN,
            this.aoBrightnessXYZNNN,
            this.aoBrightnessYZNN,
            i1renderStandardBlockWithAmbientOcclusionPartial);
    ...
    @Unique
    private boolean optimizationsAndTweaks$shouldRenderBlockSidesPartial2(Block p_147808_1_, int p_147808_2_,
        int p_147808_3_, int p_147808_4_) {
        return this.renderAllFaces
            || p_147808_1_.shouldSideBeRendered(this.blockAccess, p_147808_2_, p_147808_3_ + 1, p_147808_4_, 1);
    }

    @Unique
    private void optimizationsAndTweaks$renamethismethodlaterPartial2(Block p_147808_1_, int p_147808_2_,
        int p_147808_3_, int p_147808_4_, float p_147808_5_, float p_147808_6_, float p_147808_7_,
        int lrenderStandardBlockWithAmbientOcclusionPartial) {
        ...
        if (!flag5renderStandardBlockWithAmbientOcclusionPartial
            ...
            this.aoLightValueScratchXYZNPN = this.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_ - 1)
                .getAmbientOcclusionLightValue();
        ...
        if (!flag5renderStandardBlockWithAmbientOcclusionPartial
            ...
            this.aoLightValueScratchXYZPPN = this.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_ - 1)
                .getAmbientOcclusionLightValue();
        ...
        if (!flag4renderStandardBlockWithAmbientOcclusionPartial
            ...
            this.aoLightValueScratchXYZNPP = this.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_ + 1)
                .getAmbientOcclusionLightValue();
        ...
        if (!flag4renderStandardBlockWithAmbientOcclusionPartial
            ...
            this.aoLightValueScratchXYZPPP = this.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_ + 1)
                .getAmbientOcclusionLightValue();
        ...
        if (this.renderMaxY >= 1.0D || !this.blockAccess.getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_)
            .isOpaqueCube()) {
            i1renderStandardBlockWithAmbientOcclusionPartial = p_147808_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_ + 1, p_147808_4_);
        }
        ...
        f7renderStandardBlockWithAmbientOcclusionPartial = this.blockAccess
            .getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_)
            .getAmbientOcclusionLightValue();
        f6renderStandardBlockWithAmbientOcclusionPartial = (this.aoLightValueScratchXYZNPP
            + this.aoLightValueScratchXYNP
            + this.aoLightValueScratchYZPP
            + f7renderStandardBlockWithAmbientOcclusionPartial) / 4.0F;
        f3renderStandardBlockWithAmbientOcclusionPartial = (this.aoLightValueScratchYZPP
            + f7renderStandardBlockWithAmbientOcclusionPartial
            + this.aoLightValueScratchXYZPPP
            + this.aoLightValueScratchXYPP) / 4.0F;
        f4renderStandardBlockWithAmbientOcclusionPartial = (f7renderStandardBlockWithAmbientOcclusionPartial
            + this.aoLightValueScratchYZPN
            + this.aoLightValueScratchXYPP
            + this.aoLightValueScratchXYZPPN) / 4.0F;
        f5renderStandardBlockWithAmbientOcclusionPartial = (this.aoLightValueScratchXYNP
    ...
    @Unique
    private boolean optimizationsAndTweaks$shouldRenderBlockSidesPartial3(Block p_147808_1_, int p_147808_2_,
        int p_147808_3_, int p_147808_4_) {
        return this.renderAllFaces
    ...
    @Unique
    private void optimizationsAndTweaks$renamethismethodlaterPartial3(Block p_147808_1_, int p_147808_2_,
        int p_147808_3_, int p_147808_4_, float p_147808_5_, float p_147808_6_, float p_147808_7_,
        int lrenderStandardBlockWithAmbientOcclusionPartial) {
        ...
        this.aoBrightnessXZPN = p_147808_1_
            .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ + 1, p_147808_3_, p_147808_4_);
        flag2renderStandardBlockWithAmbientOcclusionPartial = this.blockAccess
            .getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_ - 1)
            .getCanBlockGrass();
        flag3renderStandardBlockWithAmbientOcclusionPartial = this.blockAccess
            .getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_ - 1)
            .getCanBlockGrass();
        ...
        if (!flag3renderStandardBlockWithAmbientOcclusionPartial
            && !flag5renderStandardBlockWithAmbientOcclusionPartial) {
            this.aoLightValueScratchXYZNNN = this.aoLightValueScratchXZNN;
            this.aoBrightnessXYZNNN = this.aoBrightnessXZNN;
        } else {
            this.aoLightValueScratchXYZNNN = this.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_ - 1, p_147808_4_)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZNNN = p_147808_1_
        ...
        if (!flag3renderStandardBlockWithAmbientOcclusionPartial
            && !flag4renderStandardBlockWithAmbientOcclusionPartial) {
            this.aoLightValueScratchXYZNPN = this.aoLightValueScratchXZNN;
            this.aoBrightnessXYZNPN = this.aoBrightnessXZNN;
        } else {
            this.aoLightValueScratchXYZNPN = this.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_ + 1, p_147808_4_)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZNPN = p_147808_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ - 1, p_147808_3_ + 1, p_147808_4_);
        }

        if (!flag2renderStandardBlockWithAmbientOcclusionPartial
            && !flag5renderStandardBlockWithAmbientOcclusionPartial) {
            this.aoLightValueScratchXYZPNN = this.aoLightValueScratchXZPN;
            this.aoBrightnessXYZPNN = this.aoBrightnessXZPN;
        } else {
            this.aoLightValueScratchXYZPNN = this.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_ - 1, p_147808_4_)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZPNN = p_147808_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ + 1, p_147808_3_ - 1, p_147808_4_);
        }
        ...
        if (!flag2renderStandardBlockWithAmbientOcclusionPartial
            ...
            this.aoLightValueScratchXYZPPN = this.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_ + 1, p_147808_4_)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZPPN = p_147808_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ + 1, p_147808_3_ + 1, p_147808_4_);
        }
        ...
        if (this.renderMinZ <= 0.0D || !this.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_ - 1)
            .isOpaqueCube()) {
            i1renderStandardBlockWithAmbientOcclusionPartial = p_147808_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_ - 1);
        }
        ...
        f7renderStandardBlockWithAmbientOcclusionPartial = this.blockAccess
            .getBlock(p_147808_2_, p_147808_3_, p_147808_4_ - 1)
            .getAmbientOcclusionLightValue();
        f8 = (this.aoLightValueScratchXZNN + this.aoLightValueScratchXYZNPN
            + f7renderStandardBlockWithAmbientOcclusionPartial
            + this.aoLightValueScratchYZPN) / 4.0F;
        f9 = (f7renderStandardBlockWithAmbientOcclusionPartial + this.aoLightValueScratchYZPN
            + this.aoLightValueScratchXZPN
            + this.aoLightValueScratchXYZPPN) / 4.0F;
        f10 = (this.aoLightValueScratchYZNN + f7renderStandardBlockWithAmbientOcclusionPartial
            + this.aoLightValueScratchXYZPNN
            + this.aoLightValueScratchXZPN) / 4.0F;
        f11 = (this.aoLightValueScratchXYZNNN + this.aoLightValueScratchXZNN
            + this.aoLightValueScratchYZNN
            + f7renderStandardBlockWithAmbientOcclusionPartial) / 4.0F;
        f3renderStandardBlockWithAmbientOcclusionPartial = (float) (f8 * this.renderMaxY * (1.0D - this.renderMinX)
            + f9 * this.renderMaxY * this.renderMinX
            + f10 * (1.0D - this.renderMaxY) * this.renderMinX
            + f11 * (1.0D - this.renderMaxY) * (1.0D - this.renderMinX));
        f4renderStandardBlockWithAmbientOcclusionPartial = (float) (f8 * this.renderMaxY * (1.0D - this.renderMaxX)
            + f9 * this.renderMaxY * this.renderMaxX
            + f10 * (1.0D - this.renderMaxY) * this.renderMaxX
            + f11 * (1.0D - this.renderMaxY) * (1.0D - this.renderMaxX));
        f5renderStandardBlockWithAmbientOcclusionPartial = (float) (f8 * this.renderMinY * (1.0D - this.renderMaxX)
            + f9 * this.renderMinY * this.renderMaxX
            + f10 * (1.0D - this.renderMinY) * this.renderMaxX
            + f11 * (1.0D - this.renderMinY) * (1.0D - this.renderMaxX));
        f6renderStandardBlockWithAmbientOcclusionPartial = (float) (f8 * this.renderMinY * (1.0D - this.renderMinX)
            + f9 * this.renderMinY * this.renderMinX
            + f10 * (1.0D - this.renderMinY) * this.renderMinX
            + f11 * (1.0D - this.renderMinY) * (1.0D - this.renderMinX));
        j1 = this.getAoBrightness(
            this.aoBrightnessXZNN,
            this.aoBrightnessXYZNPN,
            this.aoBrightnessYZPN,
            i1renderStandardBlockWithAmbientOcclusionPartial);
        k1 = this.getAoBrightness(
            this.aoBrightnessYZPN,
            this.aoBrightnessXZPN,
            this.aoBrightnessXYZPPN,
            i1renderStandardBlockWithAmbientOcclusionPartial);
        l1 = this.getAoBrightness(
            this.aoBrightnessYZNN,
            this.aoBrightnessXYZPNN,
            this.aoBrightnessXZPN,
            i1renderStandardBlockWithAmbientOcclusionPartial);
        i2 = this.getAoBrightness(
            this.aoBrightnessXYZNNN,
            this.aoBrightnessXZNN,
            this.aoBrightnessYZNN,
            i1renderStandardBlockWithAmbientOcclusionPartial);
        ...
        this.colorGreenTopRight *= f6renderStandardBlockWithAmbientOcclusionPartial;
        this.colorBlueTopRight *= f6renderStandardBlockWithAmbientOcclusionPartial;
        iiconrenderStandardBlockWithAmbientOcclusionPartial = this
            .getBlockIcon(p_147808_1_, this.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_, 2);
        this.renderFaceZNeg(
            p_147808_1_,
            p_147808_2_,
            p_147808_3_,
            p_147808_4_,
            iiconrenderStandardBlockWithAmbientOcclusionPartial);

        if (fancyGrass && iiconrenderStandardBlockWithAmbientOcclusionPartial.getIconName()
    ...
    @Unique
    private boolean optimizationsAndTweaks$shouldRenderBlockSidesPartial4(Block p_147808_1_, int p_147808_2_,
        int p_147808_3_, int p_147808_4_) {
        return this.renderAllFaces
    ...
    @Unique
    private void optimizationsAndTweaks$renamethismethodlaterPartial4(Block p_147808_1_, int p_147808_2_,
        int p_147808_3_, int p_147808_4_, float p_147808_5_, float p_147808_6_, float p_147808_7_,
        int lrenderStandardBlockWithAmbientOcclusionPartial) {
        ...
        if (!flag3renderStandardBlockWithAmbientOcclusionPartial
            ...
            this.aoLightValueScratchXYZNNP = this.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_ - 1, p_147808_4_)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZNNP = p_147808_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ - 1, p_147808_3_ - 1, p_147808_4_);
        }
        ...
        if (!flag3renderStandardBlockWithAmbientOcclusionPartial
            ...
            this.aoLightValueScratchXYZNPP = this.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_ + 1, p_147808_4_)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZNPP = p_147808_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ - 1, p_147808_3_ + 1, p_147808_4_);
        }
        ...
        if (!flag2renderStandardBlockWithAmbientOcclusionPartial
            ...
            this.aoLightValueScratchXYZPNP = this.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_ - 1, p_147808_4_)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZPNP = p_147808_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ + 1, p_147808_3_ - 1, p_147808_4_);
        }
        ...
        if (!flag2renderStandardBlockWithAmbientOcclusionPartial
            ...
            this.aoLightValueScratchXYZPPP = this.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_ + 1, p_147808_4_)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZPPP = p_147808_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ + 1, p_147808_3_ + 1, p_147808_4_);
        }
        ...
        if (this.renderMaxZ >= 1.0D || !this.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_ + 1)
            .isOpaqueCube()) {
            i1renderStandardBlockWithAmbientOcclusionPartial = p_147808_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_ + 1);
        }
        ...
        f7renderStandardBlockWithAmbientOcclusionPartial = this.blockAccess
            .getBlock(p_147808_2_, p_147808_3_, p_147808_4_ + 1)
            .getAmbientOcclusionLightValue();
        f8 = (this.aoLightValueScratchXZNP + this.aoLightValueScratchXYZNPP
            + f7renderStandardBlockWithAmbientOcclusionPartial
            + this.aoLightValueScratchYZPP) / 4.0F;
        f9 = (f7renderStandardBlockWithAmbientOcclusionPartial + this.aoLightValueScratchYZPP
            + this.aoLightValueScratchXZPP
            + this.aoLightValueScratchXYZPPP) / 4.0F;
        f10 = (this.aoLightValueScratchYZNP + f7renderStandardBlockWithAmbientOcclusionPartial
            + this.aoLightValueScratchXYZPNP
            + this.aoLightValueScratchXZPP) / 4.0F;
        f11 = (this.aoLightValueScratchXYZNNP + this.aoLightValueScratchXZNP
            + this.aoLightValueScratchYZNP
            + f7renderStandardBlockWithAmbientOcclusionPartial) / 4.0F;
        f3renderStandardBlockWithAmbientOcclusionPartial = (float) (f8 * this.renderMaxY * (1.0D - this.renderMinX)
            + f9 * this.renderMaxY * this.renderMinX
            + f10 * (1.0D - this.renderMaxY) * this.renderMinX
            + f11 * (1.0D - this.renderMaxY) * (1.0D - this.renderMinX));
        f4renderStandardBlockWithAmbientOcclusionPartial = (float) (f8 * this.renderMinY * (1.0D - this.renderMinX)
            + f9 * this.renderMinY * this.renderMinX
            + f10 * (1.0D - this.renderMinY) * this.renderMinX
            + f11 * (1.0D - this.renderMinY) * (1.0D - this.renderMinX));
        f5renderStandardBlockWithAmbientOcclusionPartial = (float) (f8 * this.renderMinY * (1.0D - this.renderMaxX)
            ...
            + f10 * (1.0D - this.renderMinY) * this.renderMaxX
            + f11 * (1.0D - this.renderMinY) * (1.0D - this.renderMaxX));
        f6renderStandardBlockWithAmbientOcclusionPartial = (float) (f8 * this.renderMaxY * (1.0D - this.renderMaxX)
            + f9 * this.renderMaxY * this.renderMaxX
            + f10 * (1.0D - this.renderMaxY) * this.renderMaxX
            + f11 * (1.0D - this.renderMaxY) * (1.0D - this.renderMaxX));
        j1 = this.getAoBrightness(
            this.aoBrightnessXZNP,
            this.aoBrightnessXYZNPP,
            this.aoBrightnessYZPP,
            i1renderStandardBlockWithAmbientOcclusionPartial);
        k1 = this.getAoBrightness(
            this.aoBrightnessYZPP,
            this.aoBrightnessXZPP,
            this.aoBrightnessXYZPPP,
            i1renderStandardBlockWithAmbientOcclusionPartial);
        l1 = this.getAoBrightness(
            this.aoBrightnessYZNP,
        ...
        this.colorBlueTopRight *= f6renderStandardBlockWithAmbientOcclusionPartial;
        iiconrenderStandardBlockWithAmbientOcclusionPartial = this
            .getBlockIcon(p_147808_1_, this.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_, 3);
        this.renderFaceZPos(
            p_147808_1_,
            p_147808_2_,
            p_147808_3_,
    ...
    @Unique
    private boolean optimizationsAndTweaks$shouldRenderBlockSidesPartial5(Block p_147808_1_, int p_147808_2_,
        int p_147808_3_, int p_147808_4_) {
        return this.renderAllFaces
    ...
    @Unique
    private void optimizationsAndTweaks$renamethismethodlaterPartial5(Block p_147808_1_, int p_147808_2_,
        int p_147808_3_, int p_147808_4_, float p_147808_5_, float p_147808_6_, float p_147808_7_,
        int lrenderStandardBlockWithAmbientOcclusionPartial) {
        ...
        if (!flag4renderStandardBlockWithAmbientOcclusionPartial
            ...
            this.aoLightValueScratchXYZNNN = this.blockAccess.getBlock(p_147808_2_, p_147808_3_ - 1, p_147808_4_ - 1)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZNNN = p_147808_1_
        ...
        if (!flag5renderStandardBlockWithAmbientOcclusionPartial
            ...
            this.aoLightValueScratchXYZNNP = this.blockAccess.getBlock(p_147808_2_, p_147808_3_ - 1, p_147808_4_ + 1)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZNNP = p_147808_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_ - 1, p_147808_4_ + 1);
        }
        ...
        if (!flag4renderStandardBlockWithAmbientOcclusionPartial
            ...
            this.aoLightValueScratchXYZNPN = this.blockAccess.getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_ - 1)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZNPN = p_147808_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_ + 1, p_147808_4_ - 1);
        }
        ...
        if (!flag5renderStandardBlockWithAmbientOcclusionPartial
            ...
            this.aoLightValueScratchXYZNPP = this.blockAccess.getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_ + 1)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZNPP = p_147808_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_ + 1, p_147808_4_ + 1);
        }
        ...
        if (this.renderMinX <= 0.0D || !this.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_)
            .isOpaqueCube()) {
            i1renderStandardBlockWithAmbientOcclusionPartial = p_147808_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ - 1, p_147808_3_, p_147808_4_);
        }
        ...
        f7renderStandardBlockWithAmbientOcclusionPartial = this.blockAccess
            .getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_)
            .getAmbientOcclusionLightValue();
        f8 = (this.aoLightValueScratchXYNN + this.aoLightValueScratchXYZNNP
            + f7renderStandardBlockWithAmbientOcclusionPartial
            + this.aoLightValueScratchXZNP) / 4.0F;
        f9 = (f7renderStandardBlockWithAmbientOcclusionPartial + this.aoLightValueScratchXZNP
            + this.aoLightValueScratchXYNP
            + this.aoLightValueScratchXYZNPP) / 4.0F;
        f10 = (this.aoLightValueScratchXZNN + f7renderStandardBlockWithAmbientOcclusionPartial
            + this.aoLightValueScratchXYZNPN
            + this.aoLightValueScratchXYNP) / 4.0F;
        f11 = (this.aoLightValueScratchXYZNNN + this.aoLightValueScratchXYNN
            + this.aoLightValueScratchXZNN
            + f7renderStandardBlockWithAmbientOcclusionPartial) / 4.0F;
        f3renderStandardBlockWithAmbientOcclusionPartial = (float) (f9 * this.renderMaxY * this.renderMaxZ
            + f10 * this.renderMaxY * (1.0D - this.renderMaxZ)
            + f11 * (1.0D - this.renderMaxY) * (1.0D - this.renderMaxZ)
            + f8 * (1.0D - this.renderMaxY) * this.renderMaxZ);
        f4renderStandardBlockWithAmbientOcclusionPartial = (float) (f9 * this.renderMaxY * this.renderMinZ
            + f10 * this.renderMaxY * (1.0D - this.renderMinZ)
            + f11 * (1.0D - this.renderMaxY) * (1.0D - this.renderMinZ)
            + f8 * (1.0D - this.renderMaxY) * this.renderMinZ);
        f5renderStandardBlockWithAmbientOcclusionPartial = (float) (f9 * this.renderMinY * this.renderMinZ
            + f10 * this.renderMinY * (1.0D - this.renderMinZ)
            + f11 * (1.0D - this.renderMinY) * (1.0D - this.renderMinZ)
            + f8 * (1.0D - this.renderMinY) * this.renderMinZ);
        f6renderStandardBlockWithAmbientOcclusionPartial = (float) (f9 * this.renderMinY * this.renderMaxZ
            + f10 * this.renderMinY * (1.0D - this.renderMaxZ)
            + f11 * (1.0D - this.renderMinY) * (1.0D - this.renderMaxZ)
            + f8 * (1.0D - this.renderMinY) * this.renderMaxZ);
        j1 = this.getAoBrightness(
            this.aoBrightnessXYNN,
            this.aoBrightnessXYZNNP,
            this.aoBrightnessXZNP,
        ...
        this.colorBlueTopRight *= f6renderStandardBlockWithAmbientOcclusionPartial;
        iiconrenderStandardBlockWithAmbientOcclusionPartial = this
            .getBlockIcon(p_147808_1_, this.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_, 4);
        this.renderFaceXNeg(
            p_147808_1_,
            p_147808_2_,
            p_147808_3_,
    ...
    @Unique
    private boolean optimizationsAndTweaks$shouldRenderBlockSidesPartial6(Block p_147808_1_, int p_147808_2_,
        int p_147808_3_, int p_147808_4_) {
        return this.renderAllFaces
    ...
    @Unique
    private void optimizationsAndTweaks$renamethismethodlaterPartial6(Block p_147808_1_, int p_147808_2_,
        int p_147808_3_, int p_147808_4_, float p_147808_5_, float p_147808_6_, float p_147808_7_,
        int lrenderStandardBlockWithAmbientOcclusionPartial) {
        ...
        if (!flag3renderStandardBlockWithAmbientOcclusionPartial
            ...
            this.aoLightValueScratchXYZPNN = this.blockAccess.getBlock(p_147808_2_, p_147808_3_ - 1, p_147808_4_ - 1)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZPNN = p_147808_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_ - 1, p_147808_4_ - 1);
        }
        ...
        if (!flag3renderStandardBlockWithAmbientOcclusionPartial
            ...
            this.aoLightValueScratchXYZPNP = this.blockAccess.getBlock(p_147808_2_, p_147808_3_ - 1, p_147808_4_ + 1)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZPNP = p_147808_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_ - 1, p_147808_4_ + 1);
        }
        ...
        if (!flag2renderStandardBlockWithAmbientOcclusionPartial
            ...
            this.aoLightValueScratchXYZPPN = this.blockAccess.getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_ - 1)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZPPN = p_147808_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_ + 1, p_147808_4_ - 1);
        }
        ...
        if (!flag2renderStandardBlockWithAmbientOcclusionPartial
            ...
            this.aoLightValueScratchXYZPPP = this.blockAccess.getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_ + 1)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZPPP = p_147808_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_ + 1, p_147808_4_ + 1);
        }
        ...
        if (this.renderMaxX >= 1.0D || !this.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_)
            .isOpaqueCube()) {
            i1renderStandardBlockWithAmbientOcclusionPartial = p_147808_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_ + 1, p_147808_3_, p_147808_4_);
        }
        ...
        f8 = (this.aoLightValueScratchXYPN + this.aoLightValueScratchXYZPNP
            + f7renderStandardBlockWithAmbientOcclusionPartial
            + this.aoLightValueScratchXZPP) / 4.0F;
        f9 = (this.aoLightValueScratchXYZPNN + this.aoLightValueScratchXYPN
            + this.aoLightValueScratchXZPN
            + f7renderStandardBlockWithAmbientOcclusionPartial) / 4.0F;
        f10 = (this.aoLightValueScratchXZPN + f7renderStandardBlockWithAmbientOcclusionPartial
            + this.aoLightValueScratchXYZPPN
            + this.aoLightValueScratchXYPP) / 4.0F;
        f11 = (f7renderStandardBlockWithAmbientOcclusionPartial + this.aoLightValueScratchXZPP
            + this.aoLightValueScratchXYPP
            + this.aoLightValueScratchXYZPPP) / 4.0F;
        f3renderStandardBlockWithAmbientOcclusionPartial = (float) (f8 * (1.0D - this.renderMinY) * this.renderMaxZ
            + f9 * (1.0D - this.renderMinY) * (1.0D - this.renderMaxZ)
            + f10 * this.renderMinY * (1.0D - this.renderMaxZ)
            + f11 * this.renderMinY * this.renderMaxZ);
        f4renderStandardBlockWithAmbientOcclusionPartial = (float) (f8 * (1.0D - this.renderMinY) * this.renderMinZ
            + f9 * (1.0D - this.renderMinY) * (1.0D - this.renderMinZ)
            + f10 * this.renderMinY * (1.0D - this.renderMinZ)
            + f11 * this.renderMinY * this.renderMinZ);
        f5renderStandardBlockWithAmbientOcclusionPartial = (float) (f8 * (1.0D - this.renderMaxY) * this.renderMinZ
            + f9 * (1.0D - this.renderMaxY) * (1.0D - this.renderMinZ)
            + f10 * this.renderMaxY * (1.0D - this.renderMinZ)
            + f11 * this.renderMaxY * this.renderMinZ);
        f6renderStandardBlockWithAmbientOcclusionPartial = (float) (f8 * (1.0D - this.renderMaxY) * this.renderMaxZ
            + f9 * (1.0D - this.renderMaxY) * (1.0D - this.renderMaxZ)
            + f10 * this.renderMaxY * (1.0D - this.renderMaxZ)
            + f11 * this.renderMaxY * this.renderMaxZ);
        j1 = this.getAoBrightness(
            this.aoBrightnessXYPN,
            this.aoBrightnessXYZPNP,
            this.aoBrightnessXZPP,
        ...
        this.colorBlueTopRight *= f6renderStandardBlockWithAmbientOcclusionPartial;
        iiconrenderStandardBlockWithAmbientOcclusionPartial = this
            .getBlockIcon(p_147808_1_, this.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_, 5);
        this.renderFaceXPos(
            p_147808_1_,
            p_147808_2_,
            p_147808_3_,
    ...
    public boolean renderStandardBlockWithAmbientOcclusionPartial(Block p_147808_1_, int p_147808_2_, int p_147808_3_,
        ...
        int lrenderStandardBlockWithAmbientOcclusionPartial = p_147808_1_
            .getMixedBrightnessForBlock(this.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_);
        Tessellator tessellator = Tessellator.instance;
        tessellator.setBrightness(983055);

        if (this.getBlockIcon(p_147808_1_)
            .getIconName()
            .equals("grass_top")) {
        ...
        if (optimizationsAndTweaks$shouldRenderBlockSidesPartial(p_147808_1_, p_147808_2_, p_147808_3_, p_147808_4_)) {
            optimizationsAndTweaks$renamethismethodlaterPartial(
                p_147808_1_,
                p_147808_2_,
                p_147808_3_,
                p_147808_4_,
        ...
        if (optimizationsAndTweaks$shouldRenderBlockSidesPartial3(p_147808_1_, p_147808_2_, p_147808_3_, p_147808_4_)) {
            optimizationsAndTweaks$renamethismethodlaterPartial3(
                p_147808_1_,
                p_147808_2_,
                p_147808_3_,
                p_147808_4_,
        ...
        if (optimizationsAndTweaks$shouldRenderBlockSidesPartial4(p_147808_1_, p_147808_2_, p_147808_3_, p_147808_4_)) {
            optimizationsAndTweaks$renamethismethodlaterPartial4(
                p_147808_1_,
                p_147808_2_,
                p_147808_3_,
                p_147808_4_,
        ...
        if (optimizationsAndTweaks$shouldRenderBlockSidesPartial5(p_147808_1_, p_147808_2_, p_147808_3_, p_147808_4_)) {
            optimizationsAndTweaks$renamethismethodlaterPartial5(
                p_147808_1_,
                p_147808_2_,
                p_147808_3_,
                p_147808_4_,
        ...
        if (optimizationsAndTweaks$shouldRenderBlockSidesPartial6(p_147808_1_, p_147808_2_, p_147808_3_, p_147808_4_)) {
            optimizationsAndTweaks$renamethismethodlaterPartial6(
                p_147808_1_,
                p_147808_2_,
                p_147808_3_,
                p_147808_4_,
    ...
    @Unique
    private void optimizationsAndTweaks$renamethismethodlater(Block p_147751_1_, int p_147751_2_, int p_147751_3_,
        int p_147751_4_, float p_147751_5_, float p_147751_6_, float p_147751_7_,
        int lrenderStandardBlockWithAmbientOcclusion) {
        if (this.renderMinY <= 0.0D) {
            --p_147751_3_;
        }
        ...
        this.aoLightValueScratchXYPN = this.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_)
            .getAmbientOcclusionLightValue();
        flag2renderStandardBlockWithAmbientOcclusion = this.blockAccess
            .getBlock(p_147751_2_ + 1, p_147751_3_ - 1, p_147751_4_)
            .getCanBlockGrass();
        flag3renderStandardBlockWithAmbientOcclusion = this.blockAccess
            .getBlock(p_147751_2_ - 1, p_147751_3_ - 1, p_147751_4_)
            .getCanBlockGrass();
        flag4renderStandardBlockWithAmbientOcclusion = this.blockAccess
            .getBlock(p_147751_2_, p_147751_3_ - 1, p_147751_4_ + 1)
            .getCanBlockGrass();
        flag5renderStandardBlockWithAmbientOcclusion = this.blockAccess
            .getBlock(p_147751_2_, p_147751_3_ - 1, p_147751_4_ - 1)
            .getCanBlockGrass();
        ...
        if (!flag5renderStandardBlockWithAmbientOcclusion && !flag3renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZNNN = this.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_ - 1)
                .getAmbientOcclusionLightValue();
        ...
        if (!flag4renderStandardBlockWithAmbientOcclusion && !flag3renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZNNP = this.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_ + 1)
                .getAmbientOcclusionLightValue();
        ...
        if (!flag5renderStandardBlockWithAmbientOcclusion && !flag2renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZPNN = this.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_ - 1)
                .getAmbientOcclusionLightValue();
        ...
        if (!flag4renderStandardBlockWithAmbientOcclusion && !flag2renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZPNP = this.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_ + 1)
                .getAmbientOcclusionLightValue();
        ...
        if (this.renderMinY <= 0.0D || !this.blockAccess.getBlock(p_147751_2_, p_147751_3_ - 1, p_147751_4_)
            .isOpaqueCube()) {
            i1renderStandardBlockWithAmbientOcclusion = p_147751_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_ - 1, p_147751_4_);
        }

        f7renderStandardBlockWithAmbientOcclusion = this.blockAccess.getBlock(p_147751_2_, p_147751_3_ - 1, p_147751_4_)
            .getAmbientOcclusionLightValue();
        f3renderStandardBlockWithAmbientOcclusion = (this.aoLightValueScratchXYZNNP + this.aoLightValueScratchXYNN
            + this.aoLightValueScratchYZNP
            + f7renderStandardBlockWithAmbientOcclusion) / 4.0F;
        f6renderStandardBlockWithAmbientOcclusion = (this.aoLightValueScratchYZNP
            + f7renderStandardBlockWithAmbientOcclusion
            + this.aoLightValueScratchXYZPNP
            + this.aoLightValueScratchXYPN) / 4.0F;
        f5renderStandardBlockWithAmbientOcclusion = (f7renderStandardBlockWithAmbientOcclusion
            + this.aoLightValueScratchYZNN
            + this.aoLightValueScratchXYPN
            + this.aoLightValueScratchXYZPNN) / 4.0F;
        f4renderStandardBlockWithAmbientOcclusion = (this.aoLightValueScratchXYNN + this.aoLightValueScratchXYZNNN
            + f7renderStandardBlockWithAmbientOcclusion
            + this.aoLightValueScratchYZNN) / 4.0F;
        this.brightnessTopLeft = this.getAoBrightness(
            this.aoBrightnessXYZNNP,
            this.aoBrightnessXYNN,
            this.aoBrightnessYZNP,
            i1renderStandardBlockWithAmbientOcclusion);
        this.brightnessTopRight = this.getAoBrightness(
            this.aoBrightnessYZNP,
            this.aoBrightnessXYZPNP,
            this.aoBrightnessXYPN,
    ...
    @Unique
    public void optimizationsAndTweaks$renamethismethodlater2(Block p_147751_1_, int p_147751_2_, int p_147751_3_,
        int p_147751_4_, float p_147751_5_, float p_147751_6_, float p_147751_7_,
        int lrenderStandardBlockWithAmbientOcclusion) {
        if (this.renderMaxY >= 1.0D) {
            ++p_147751_3_;
        ...
        if (!flag5renderStandardBlockWithAmbientOcclusion && !flag3renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZNPN = this.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_ - 1)
                .getAmbientOcclusionLightValue();
        ...
        if (!flag5renderStandardBlockWithAmbientOcclusion && !flag2renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZPPN = this.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_ - 1)
                .getAmbientOcclusionLightValue();
        ...
        if (!flag4renderStandardBlockWithAmbientOcclusion && !flag3renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZNPP = this.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_ + 1)
                .getAmbientOcclusionLightValue();
        ...
        if (!flag4renderStandardBlockWithAmbientOcclusion && !flag2renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZPPP = this.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_ + 1)
                .getAmbientOcclusionLightValue();
        ...
        if (this.renderMaxY >= 1.0D || !this.blockAccess.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_)
            .isOpaqueCube()) {
            i1renderStandardBlockWithAmbientOcclusion = p_147751_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_ + 1, p_147751_4_);
        }
        ...
        f7renderStandardBlockWithAmbientOcclusion = this.blockAccess.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_)
            .getAmbientOcclusionLightValue();
        f6renderStandardBlockWithAmbientOcclusion = (this.aoLightValueScratchXYZNPP + this.aoLightValueScratchXYNP
            + this.aoLightValueScratchYZPP
            + f7renderStandardBlockWithAmbientOcclusion) / 4.0F;
        f3renderStandardBlockWithAmbientOcclusion = (this.aoLightValueScratchYZPP
            + f7renderStandardBlockWithAmbientOcclusion
            + this.aoLightValueScratchXYZPPP
            + this.aoLightValueScratchXYPP) / 4.0F;
        f4renderStandardBlockWithAmbientOcclusion = (f7renderStandardBlockWithAmbientOcclusion
            + this.aoLightValueScratchYZPN
            + this.aoLightValueScratchXYPP
            + this.aoLightValueScratchXYZPPN) / 4.0F;
        f5renderStandardBlockWithAmbientOcclusion = (this.aoLightValueScratchXYNP + this.aoLightValueScratchXYZNPN
            + f7renderStandardBlockWithAmbientOcclusion
            + this.aoLightValueScratchYZPN) / 4.0F;
        this.brightnessTopRight = this.getAoBrightness(
            this.aoBrightnessXYZNPP,
    ...
    @Unique
    private boolean optimizationsAndTweaks$shouldRenderBlockSides3(Block p_147751_1_, int p_147751_2_, int p_147751_3_,
        int p_147751_4_) {
        return this.renderAllFaces
    ...
    @Unique
    public void optimizationsAndTweaks$renamethismethodlater3(Block p_147751_1_, int p_147751_2_, int p_147751_3_,
        int p_147751_4_, float p_147751_5_, float p_147751_6_, float p_147751_7_,
        int lrenderStandardBlockWithAmbientOcclusion) {
        if (this.renderMinZ <= 0.0D) {
            --p_147751_4_;
        ...
        this.aoBrightnessXZPN = p_147751_1_
            .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ + 1, p_147751_3_, p_147751_4_);
        flag2renderStandardBlockWithAmbientOcclusion = this.blockAccess
            .getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_ - 1)
            .getCanBlockGrass();
        flag3renderStandardBlockWithAmbientOcclusion = this.blockAccess
            .getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_ - 1)
            .getCanBlockGrass();
        ...
        if (!flag3renderStandardBlockWithAmbientOcclusion && !flag5renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZNNN = this.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_ - 1, p_147751_4_)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZNNN = p_147751_1_
        ...
        if (!flag3renderStandardBlockWithAmbientOcclusion && !flag4renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZNPN = this.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_ + 1, p_147751_4_)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZNPN = p_147751_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ - 1, p_147751_3_ + 1, p_147751_4_);
        }
        ...
        if (!flag2renderStandardBlockWithAmbientOcclusion && !flag5renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZPNN = this.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_ - 1, p_147751_4_)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZPNN = p_147751_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ + 1, p_147751_3_ - 1, p_147751_4_);
        }
        ...
        if (!flag2renderStandardBlockWithAmbientOcclusion && !flag4renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZPPN = this.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_ + 1, p_147751_4_)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZPPN = p_147751_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ + 1, p_147751_3_ + 1, p_147751_4_);
        }
        ...
        if (this.renderMinZ <= 0.0D || !this.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_ - 1)
            .isOpaqueCube()) {
            i1renderStandardBlockWithAmbientOcclusion = p_147751_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_ - 1);
        }

        f7renderStandardBlockWithAmbientOcclusion = this.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_ - 1)
            .getAmbientOcclusionLightValue();
        f3renderStandardBlockWithAmbientOcclusion = (this.aoLightValueScratchXZNN + this.aoLightValueScratchXYZNPN
            + f7renderStandardBlockWithAmbientOcclusion
            + this.aoLightValueScratchYZPN) / 4.0F;
        f4renderStandardBlockWithAmbientOcclusion = (f7renderStandardBlockWithAmbientOcclusion
            + this.aoLightValueScratchYZPN
            + this.aoLightValueScratchXZPN
            + this.aoLightValueScratchXYZPPN) / 4.0F;
        f5renderStandardBlockWithAmbientOcclusion = (this.aoLightValueScratchYZNN
            + f7renderStandardBlockWithAmbientOcclusion
            + this.aoLightValueScratchXYZPNN
            + this.aoLightValueScratchXZPN) / 4.0F;
        f6renderStandardBlockWithAmbientOcclusion = (this.aoLightValueScratchXYZNNN + this.aoLightValueScratchXZNN
            + this.aoLightValueScratchYZNN
            + f7renderStandardBlockWithAmbientOcclusion) / 4.0F;
        this.brightnessTopLeft = this.getAoBrightness(
            this.aoBrightnessXZNN,
        ...
        this.colorGreenTopRight *= f6renderStandardBlockWithAmbientOcclusion;
        this.colorBlueTopRight *= f6renderStandardBlockWithAmbientOcclusion;
        iiconrenderStandardBlockWithAmbientOcclusion = this
            .getBlockIcon(p_147751_1_, this.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_, 2);
        this.renderFaceZNeg(
            p_147751_1_,
            p_147751_2_,
            p_147751_3_,
            p_147751_4_,
            iiconrenderStandardBlockWithAmbientOcclusion);

        if (fancyGrass && iiconrenderStandardBlockWithAmbientOcclusion.getIconName()
            .equals("grass_side") && !this.hasOverrideBlockTexture()) {
    ...
    @Unique
    private boolean optimizationsAndTweaks$shouldRenderBlockSides4(Block p_147751_1_, int p_147751_2_, int p_147751_3_,
        int p_147751_4_) {
        return this.renderAllFaces
    ...
    @Unique
    public void optimizationsAndTweaks$renamethismethodlater4(Block p_147751_1_, int p_147751_2_, int p_147751_3_,
        int p_147751_4_, float p_147751_5_, float p_147751_6_, float p_147751_7_,
        int lrenderStandardBlockWithAmbientOcclusion) {
        if (this.renderMaxZ >= 1.0D) {
            ++p_147751_4_;
        ...
        if (!flag3renderStandardBlockWithAmbientOcclusion && !flag5renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZNNP = this.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_ - 1, p_147751_4_)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZNNP = p_147751_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ - 1, p_147751_3_ - 1, p_147751_4_);
        }
        ...
        if (!flag3renderStandardBlockWithAmbientOcclusion && !flag4renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZNPP = this.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_ + 1, p_147751_4_)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZNPP = p_147751_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ - 1, p_147751_3_ + 1, p_147751_4_);
        }
        ...
        if (!flag2renderStandardBlockWithAmbientOcclusion && !flag5renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZPNP = this.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_ - 1, p_147751_4_)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZPNP = p_147751_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ + 1, p_147751_3_ - 1, p_147751_4_);
        }
        ...
        if (!flag2renderStandardBlockWithAmbientOcclusion && !flag4renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZPPP = this.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_ + 1, p_147751_4_)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZPPP = p_147751_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ + 1, p_147751_3_ + 1, p_147751_4_);
        }
        ...
        if (this.renderMaxZ >= 1.0D || !this.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_ + 1)
            .isOpaqueCube()) {
            i1renderStandardBlockWithAmbientOcclusion = p_147751_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_ + 1);
        }
        ...
        f7renderStandardBlockWithAmbientOcclusion = this.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_ + 1)
            .getAmbientOcclusionLightValue();
        f3renderStandardBlockWithAmbientOcclusion = (this.aoLightValueScratchXZNP + this.aoLightValueScratchXYZNPP
            + f7renderStandardBlockWithAmbientOcclusion
            + this.aoLightValueScratchYZPP) / 4.0F;
        f6renderStandardBlockWithAmbientOcclusion = (f7renderStandardBlockWithAmbientOcclusion
            + this.aoLightValueScratchYZPP
            + this.aoLightValueScratchXZPP
            + this.aoLightValueScratchXYZPPP) / 4.0F;
        f5renderStandardBlockWithAmbientOcclusion = (this.aoLightValueScratchYZNP
            + f7renderStandardBlockWithAmbientOcclusion
            + this.aoLightValueScratchXYZPNP
            + this.aoLightValueScratchXZPP) / 4.0F;
        f4renderStandardBlockWithAmbientOcclusion = (this.aoLightValueScratchXYZNNP + this.aoLightValueScratchXZNP
            + this.aoLightValueScratchYZNP
            + f7renderStandardBlockWithAmbientOcclusion) / 4.0F;
        this.brightnessTopLeft = this.getAoBrightness(
            this.aoBrightnessXZNP,
        ...
        this.colorBlueTopRight *= f6renderStandardBlockWithAmbientOcclusion;
        iiconrenderStandardBlockWithAmbientOcclusion = this
            .getBlockIcon(p_147751_1_, this.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_, 3);
        this.renderFaceZPos(
            p_147751_1_,
            p_147751_2_,
            p_147751_3_,
    ...
    @Unique
    private boolean optimizationsAndTweaks$shouldRenderBlockSides5(Block p_147751_1_, int p_147751_2_, int p_147751_3_,
        int p_147751_4_) {
        return this.renderAllFaces
    ...
    @Unique
    public void optimizationsAndTweaks$renamethismethodlater5(Block p_147751_1_, int p_147751_2_, int p_147751_3_,
        int p_147751_4_, float p_147751_5_, float p_147751_6_, float p_147751_7_,
        int lrenderStandardBlockWithAmbientOcclusion) {
        if (this.renderMinX <= 0.0D) {
            --p_147751_2_;
        ...
        if (!flag4renderStandardBlockWithAmbientOcclusion && !flag3renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZNNN = this.blockAccess.getBlock(p_147751_2_, p_147751_3_ - 1, p_147751_4_ - 1)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZNNN = p_147751_1_
        ...
        if (!flag5renderStandardBlockWithAmbientOcclusion && !flag3renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZNNP = this.blockAccess.getBlock(p_147751_2_, p_147751_3_ - 1, p_147751_4_ + 1)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZNNP = p_147751_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_ - 1, p_147751_4_ + 1);
        }
        ...
        if (!flag4renderStandardBlockWithAmbientOcclusion && !flag2renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZNPN = this.blockAccess.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_ - 1)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZNPN = p_147751_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_ + 1, p_147751_4_ - 1);
        }
        ...
        if (!flag5renderStandardBlockWithAmbientOcclusion && !flag2renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZNPP = this.blockAccess.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_ + 1)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZNPP = p_147751_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_ + 1, p_147751_4_ + 1);
        }
        ...
        if (this.renderMinX <= 0.0D || !this.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_)
            .isOpaqueCube()) {
            i1renderStandardBlockWithAmbientOcclusion = p_147751_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ - 1, p_147751_3_, p_147751_4_);
        }

        f7renderStandardBlockWithAmbientOcclusion = this.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_)
            .getAmbientOcclusionLightValue();
        f6renderStandardBlockWithAmbientOcclusion = (this.aoLightValueScratchXYNN + this.aoLightValueScratchXYZNNP
            + f7renderStandardBlockWithAmbientOcclusion
            + this.aoLightValueScratchXZNP) / 4.0F;
        f3renderStandardBlockWithAmbientOcclusion = (f7renderStandardBlockWithAmbientOcclusion
            + this.aoLightValueScratchXZNP
            + this.aoLightValueScratchXYNP
            + this.aoLightValueScratchXYZNPP) / 4.0F;
        f4renderStandardBlockWithAmbientOcclusion = (this.aoLightValueScratchXZNN
            + f7renderStandardBlockWithAmbientOcclusion
            + this.aoLightValueScratchXYZNPN
            + this.aoLightValueScratchXYNP) / 4.0F;
        f5renderStandardBlockWithAmbientOcclusion = (this.aoLightValueScratchXYZNNN + this.aoLightValueScratchXYNN
            + this.aoLightValueScratchXZNN
            + f7renderStandardBlockWithAmbientOcclusion) / 4.0F;
        this.brightnessTopRight = this.getAoBrightness(
            this.aoBrightnessXYNN,
        ...
        this.colorBlueTopRight *= f6renderStandardBlockWithAmbientOcclusion;
        iiconrenderStandardBlockWithAmbientOcclusion = this
            .getBlockIcon(p_147751_1_, this.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_, 4);
        this.renderFaceXNeg(
            p_147751_1_,
            p_147751_2_,
            p_147751_3_,
    ...
    @Unique
    private boolean optimizationsAndTweaks$shouldRenderBlockSides6(Block p_147751_1_, int p_147751_2_, int p_147751_3_,
        int p_147751_4_) {
        return this.renderAllFaces
    ...
    @Unique
    public void optimizationsAndTweaks$renamethismethodlater6(Block p_147751_1_, int p_147751_2_, int p_147751_3_,
        int p_147751_4_, float p_147751_5_, float p_147751_6_, float p_147751_7_,
        int lrenderStandardBlockWithAmbientOcclusion) {
        if (this.renderMaxX >= 1.0D) {
            ++p_147751_2_;
        ...
        if (!flag3renderStandardBlockWithAmbientOcclusion && !flag5renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZPNN = this.blockAccess.getBlock(p_147751_2_, p_147751_3_ - 1, p_147751_4_ - 1)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZPNN = p_147751_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_ - 1, p_147751_4_ - 1);
        }
        ...
        if (!flag3renderStandardBlockWithAmbientOcclusion && !flag4renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZPNP = this.blockAccess.getBlock(p_147751_2_, p_147751_3_ - 1, p_147751_4_ + 1)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZPNP = p_147751_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_ - 1, p_147751_4_ + 1);
        }
        ...
        if (!flag2renderStandardBlockWithAmbientOcclusion && !flag5renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZPPN = this.blockAccess.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_ - 1)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZPPN = p_147751_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_ + 1, p_147751_4_ - 1);
        }
        ...
        if (!flag2renderStandardBlockWithAmbientOcclusion && !flag4renderStandardBlockWithAmbientOcclusion) {
            ...
            this.aoLightValueScratchXYZPPP = this.blockAccess.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_ + 1)
                .getAmbientOcclusionLightValue();
            this.aoBrightnessXYZPPP = p_147751_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_ + 1, p_147751_4_ + 1);
        }
        ...
        if (this.renderMaxX >= 1.0D || !this.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_)
            .isOpaqueCube()) {
            i1renderStandardBlockWithAmbientOcclusion = p_147751_1_
                .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_ + 1, p_147751_3_, p_147751_4_);
        }
        ...
        f7renderStandardBlockWithAmbientOcclusion = this.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_)
            .getAmbientOcclusionLightValue();
        f3renderStandardBlockWithAmbientOcclusion = (this.aoLightValueScratchXYPN + this.aoLightValueScratchXYZPNP
            + f7renderStandardBlockWithAmbientOcclusion
            + this.aoLightValueScratchXZPP) / 4.0F;
        f4renderStandardBlockWithAmbientOcclusion = (this.aoLightValueScratchXYZPNN + this.aoLightValueScratchXYPN
            + this.aoLightValueScratchXZPN
            + f7renderStandardBlockWithAmbientOcclusion) / 4.0F;
        f5renderStandardBlockWithAmbientOcclusion = (this.aoLightValueScratchXZPN
            + f7renderStandardBlockWithAmbientOcclusion
            + this.aoLightValueScratchXYZPPN
            + this.aoLightValueScratchXYPP) / 4.0F;
        f6renderStandardBlockWithAmbientOcclusion = (f7renderStandardBlockWithAmbientOcclusion
        ...
        this.colorBlueTopRight *= f6renderStandardBlockWithAmbientOcclusion;
        iiconrenderStandardBlockWithAmbientOcclusion = this
            .getBlockIcon(p_147751_1_, this.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_, 5);
        this.renderFaceXPos(
            p_147751_1_,
            p_147751_2_,
            p_147751_3_,
    ...
    public boolean renderStandardBlockWithAmbientOcclusion(Block p_147751_1_, int p_147751_2_, int p_147751_3_,
        ...
        int lrenderStandardBlockWithAmbientOcclusion = p_147751_1_
            .getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_);
        Tessellator tessellator = Tessellator.instance;
        tessellator.setBrightness(983055);

        if (this.getBlockIcon(p_147751_1_)
            .getIconName()
            .equals("grass_top")) {
        ...
        if (optimizationsAndTweaks$shouldRenderBlockSides(p_147751_1_, p_147751_2_, p_147751_3_, p_147751_4_)) {
            optimizationsAndTweaks$renamethismethodlater(
                p_147751_1_,
                p_147751_2_,
                p_147751_3_,
                p_147751_4_,
        ...
        if (optimizationsAndTweaks$shouldRenderBlockSides3(p_147751_1_, p_147751_2_, p_147751_3_, p_147751_4_)) {
            optimizationsAndTweaks$renamethismethodlater3(
                p_147751_1_,
                p_147751_2_,
                p_147751_3_,
                p_147751_4_,
        ...
        if (optimizationsAndTweaks$shouldRenderBlockSides4(p_147751_1_, p_147751_2_, p_147751_3_, p_147751_4_)) {
            optimizationsAndTweaks$renamethismethodlater4(
                p_147751_1_,
                p_147751_2_,
                p_147751_3_,
                p_147751_4_,
        ...
        if (optimizationsAndTweaks$shouldRenderBlockSides5(p_147751_1_, p_147751_2_, p_147751_3_, p_147751_4_)) {
            optimizationsAndTweaks$renamethismethodlater5(
                p_147751_1_,
                p_147751_2_,
                p_147751_3_,
                p_147751_4_,
        ...
        if (optimizationsAndTweaks$shouldRenderBlockSides6(p_147751_1_, p_147751_2_, p_147751_3_, p_147751_4_)) {
            optimizationsAndTweaks$renamethismethodlater6(
                p_147751_1_,
                p_147751_2_,
                p_147751_3_,
                p_147751_4_,
    ...
    public boolean renderStandardBlock(Block blockType, int blockX, int blockY, int blockZ) {
        ...
        if (EntityRenderer.anaglyphEnable) {
            float f3 = (frenderStandardBlock * 30.0F + f1renderStandardBlock * 59.0F + f2renderStandardBlock * 11.0F)
                / 100.0F;
        ...
        return Minecraft.isAmbientOcclusionEnabled() && blockType.getLightValue() == 0
            ? (this.partialRenderBounds
                ? this.renderStandardBlockWithAmbientOcclusionPartial(
                    blockType,
                    blockX,
                    blockY,
                    blockZ,
                    frenderStandardBlock,
                    f1renderStandardBlock,
                    f2renderStandardBlock)
                : this.renderStandardBlockWithAmbientOcclusion(
                    blockType,
                    blockX,
                    blockY,
                    blockZ,
                    ...
                    f1renderStandardBlock,
                    f2renderStandardBlock))
            : this.renderStandardBlockWithColorMultiplier(
                blockType,
                blockX,
                blockY,
                blockZ,
    ...
    public int mixAoBrightness(int p_147727_1_, int p_147727_2_, int p_147727_3_, int p_147727_4_, double p_147727_5_,
        ...
        int i1 = (int) ((p_147727_1_ >> 16 & 255) * p_147727_5_ + (p_147727_2_ >> 16 & 255) * p_147727_7_
            + (p_147727_3_ >> 16 & 255) * p_147727_9_
            + (p_147727_4_ >> 16 & 255) * p_147727_11_) & 255;
        int j1 = (int) ((p_147727_1_ & 255) * p_147727_5_ + (p_147727_2_ & 255) * p_147727_7_
            + (p_147727_3_ & 255) * p_147727_9_
            + (p_147727_4_ & 255) * p_147727_11_) & 255;
        return i1 << 16 | j1;
    }
    ...
    public boolean renderStandardBlockWithColorMultiplier(Block p_147736_1_, int p_147736_2_, int p_147736_3_,
        ...
        if (this.renderAllFaces
            ...
            tessellator.setBrightness(
                this.renderMinY > 0.0D ? l
                    : p_147736_1_
                        .getMixedBrightnessForBlock(this.blockAccess, p_147736_2_, p_147736_3_ - 1, p_147736_4_));
        ...
        if (this.renderAllFaces
            ...
            tessellator.setBrightness(
                this.renderMinZ > 0.0D ? l
                    : p_147736_1_
                        .getMixedBrightnessForBlock(this.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_ - 1));
        ...
        if (this.renderAllFaces
            ...
            tessellator.setBrightness(
                this.renderMinX > 0.0D ? l
                    : p_147736_1_
                        .getMixedBrightnessForBlock(this.blockAccess, p_147736_2_ - 1, p_147736_3_, p_147736_4_));
