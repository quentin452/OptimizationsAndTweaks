...
import fr.iamacat.optimizationsandtweaks.utils.optimizationsandtweaks.GZIPInputStream2;
import fr.iamacat.optimizationsandtweaks.utils.optimizationsandtweaks.GZIPOutputStream2;
...
public abstract class MixinCompressedStreamTools {
    ...
    {
        DataInputStream datainputstream = new DataInputStream(new BufferedInputStream(new GZIPInputStream2(p_74796_0_)));
    ...
    public static void writeCompressed(NBTTagCompound p_74799_0_, OutputStream p_74799_1_) throws IOException
    {
        ...
        try (DataOutputStream dataoutputstream = new DataOutputStream(new BufferedOutputStream(new GZIPOutputStream2(p_74799_1_)))) {
    ...
    {
        DataInputStream datainputstream = new DataInputStream(new BufferedInputStream(new GZIPInputStream2(new ByteArrayInputStream(p_152457_0_))));
        NBTTagCompound nbttagcompound;
    ...
    private static NBTBase func_152455_a(DataInput p_152455_0_, int p_152455_1_, NBTSizeTracker p_152455_2_) throws IOException {
        try {
            ...
            Method func_152446_a = NBTBase.class.getDeclaredMethod("func_152446_a", DataInput.class, int.class, NBTSizeTracker.class);
