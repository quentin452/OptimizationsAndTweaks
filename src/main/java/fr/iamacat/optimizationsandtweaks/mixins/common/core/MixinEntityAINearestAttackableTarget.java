...
public class MixinEntityAINearestAttackableTarget extends EntityAITarget {
    ...
    public MixinEntityAINearestAttackableTarget(EntityCreature p_i1663_1_, Class p_i1663_2_, int p_i1663_3_,
        boolean p_i1663_4_) {
            ...
            public boolean isEntityApplicable(Entity p_82704_1_) {
                return !(p_82704_1_ instanceof EntityLivingBase) ? false
                    : (p_i1665_6_ != null && !p_i1665_6_.isEntityApplicable(p_82704_1_) ? false
                        : isSuitableTarget((EntityLivingBase) p_82704_1_, false));
            }
        };
    }
