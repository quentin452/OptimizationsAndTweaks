        ...
        else if (!(this.myEntity instanceof IAnimals) && !(this.myEntity instanceof EntityDragon))
        {
            ...
            else
            {
                ...
                else if (this.myEntity instanceof EntityXPOrb)
                {
                    ...
                    // todo : fix this warn with tumbleweed(probably caused by usage of CompletableFuture in SpawnerAnimals)
                    logger.error("Don't know how to add " + this.myEntity.getClass() + "!");
                    logger.error("Entity position: " + this.myEntity.posX + ", " + this.myEntity.posY + ", " + this.myEntity.posZ);
                    logger.error("Entity velocity: " + this.myEntity.motionX + ", " + this.myEntity.motionY + ", " + this.myEntity.motionZ);
