...
public abstract class MixinNBTTagCompound extends NBTBase
{
    ...
    private java.util.Map redirectfunc_152446_a(
    ...
    public byte getByte(String key)
    {
        try
        {
            return !this.optimizationsAndTweaks$tagMap.containsKey(key) ? 0 : ((NBTBase.NBTPrimitive)this.optimizationsAndTweaks$tagMap.get(key)).func_150290_f();
        }
    ...
    public short getShort(String key)
    {
        try
        {
            return !this.optimizationsAndTweaks$tagMap.containsKey(key) ? 0 : ((NBTBase.NBTPrimitive)this.optimizationsAndTweaks$tagMap.get(key)).func_150289_e();
        }
        catch (ClassCastException classcastexception)
        {
            return (short)0;
    ...
    public int getInteger(String key)
    {
        try
        {
            return !this.optimizationsAndTweaks$tagMap.containsKey(key) ? 0 : ((NBTBase.NBTPrimitive)this.optimizationsAndTweaks$tagMap.get(key)).func_150287_d();
        }
        catch (ClassCastException classcastexception)
        {
            return 0;
    ...
    public long getLong(String key)
    {
        try
        {
            return !this.optimizationsAndTweaks$tagMap.containsKey(key) ? 0L : ((NBTBase.NBTPrimitive)this.optimizationsAndTweaks$tagMap.get(key)).func_150291_c();
        }
        catch (ClassCastException classcastexception)
        {
            return 0L;
    ...
    public float getFloat(String key)
    {
        try
        {
            return !this.optimizationsAndTweaks$tagMap.containsKey(key) ? 0.0F : ((NBTBase.NBTPrimitive)this.optimizationsAndTweaks$tagMap.get(key)).func_150288_h();
        }
        catch (ClassCastException classcastexception)
        {
            return 0.0F;
    ...
    public double getDouble(String key)
    {
        try
        {
            return !this.optimizationsAndTweaks$tagMap.containsKey(key) ? 0.0D : ((NBTBase.NBTPrimitive)this.optimizationsAndTweaks$tagMap.get(key)).func_150286_g();
        }
        catch (ClassCastException classcastexception)
        {
            return 0.0D;
    ...
    public byte[] getByteArray(String key)
    {
        try
        {
            return !this.optimizationsAndTweaks$tagMap.containsKey(key) ? new byte[0] : ((NBTTagByteArray)this.optimizationsAndTweaks$tagMap.get(key)).func_150292_c();
        }
        catch (ClassCastException classcastexception)
        {
    ...
    public int[] getIntArray(String key)
    {
        try
        {
            return !this.optimizationsAndTweaks$tagMap.containsKey(key) ? new int[0] : ((NBTTagIntArray)this.optimizationsAndTweaks$tagMap.get(key)).func_150302_c();
        }
        catch (ClassCastException classcastexception)
        {
    ...
    public NBTTagCompound getCompoundTag(String key)
    {
        try
        {
            return !this.optimizationsAndTweaks$tagMap.containsKey(key) ? new NBTTagCompound() : (NBTTagCompound)this.optimizationsAndTweaks$tagMap.get(key);
        }
        catch (ClassCastException classcastexception)
        {
    ...
    public String toString()
    {
        ...
        for (Iterator iterator = this.optimizationsAndTweaks$tagMap.keySet().iterator(); iterator.hasNext(); s = s + s1 + ':' + this.optimizationsAndTweaks$tagMap.get(s1) + ',')
        {
    ...
    private CrashReport createCrashReport(final String p_82581_1_, final int p_82581_2_, ClassCastException p_82581_3_)
    {
        ...
        crashreportcategory.addCrashSectionCallable("Tag type found", () -> NBTBase.NBTTypes[((NBTBase)this.optimizationsAndTweaks$tagMap.get(p_82581_1_)).getId()]);
