...
public class MixinRandomPositionGenerator {
     ...
     */
    @Overwrite
    private static Vec3 findRandomTargetBlock(EntityCreature entity, int maxHorizontalDistance, int maxVerticalDistance,
        ...
        for (int i = 0; i < 10; ++i) {
            ...
            if (preferredDirection == null
                || randomX * preferredDirection.xCoord + randomZ * preferredDirection.zCoord >= 0.0D) {
