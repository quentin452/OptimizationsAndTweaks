    ...
    public static void init(File configFile) {
        ...
        try {
            ...
            versionChecker = config
                .getBoolean("Version Checker: ", "general", true, "If the version checker should be enabled.");
            snowboolean = config.getBoolean(
                "Blizzard activation: ",
                "general",
                false,
                "Please be sure that this feature could cause lags!");
            hypothermiaboolean = config.getBoolean("Hypothermia activation", "general", true, "");
            dimensionID = config
                .getInt("Dimension ID: ", "dimension", 4, 2, 65536, "What ID number to assign to the Eternal Frost");
            FMLCommonHandler.instance()
                .getFMLLogger()
                .log(Level.INFO, "[Eternal Frost] Generating Biome ID's");
            ...
            FMLCommonHandler.instance()
                .getFMLLogger()
                .log(Level.INFO, "[Eternal Frost] Generated Config!");
