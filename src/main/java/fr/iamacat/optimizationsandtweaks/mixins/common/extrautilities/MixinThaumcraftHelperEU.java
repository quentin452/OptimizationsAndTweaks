...
public class MixinThaumcraftHelperEU {
    ...
    private static void registerItems_do() {
        ...
        if (ExtraUtils.decorative1 != null) {
            ...
            addAspectRecipe(new ItemStack(ExtraUtils.decorative1, 1, 10), Blocks.gravel, Blocks.gravel, Aspect.TRAVEL, 1);
            ...
            addAspectRecipe(new ItemStack(ExtraUtils.decorative1, 1, 14), Blocks.stonebrick, Aspect.SENSES, 2, Aspect.ELDRITCH, 2);
