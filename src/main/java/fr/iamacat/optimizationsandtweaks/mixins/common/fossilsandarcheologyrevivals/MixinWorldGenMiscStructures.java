...
public class MixinWorldGenMiscStructures {
    ...
    private void generateMoaiStructures(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) {
    ...
    public void generateHellShips(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) {
    ...
    public void generate1(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) {
        counter = chunkX * 16 + random.nextInt(16);
        Zcoord1 = chunkZ * 16 + random.nextInt(16);
        base = world.getHeightValue(counter, Zcoord1);
        biome = world.getWorldChunkManager().getBiomeGenAt(counter, Zcoord1);
        if (BiomeDictionary.isBiomeOfType(biome, BiomeDictionary.Type.BEACH) && !world.provider.hasNoSky && !world.provider.isHellWorld && world.getBlock(counter, base - 1, Zcoord1) == Blocks.sand) {
            (new MoaiWorldGen()).func_76484_a(world, random, counter, base - random.nextInt(4), Zcoord1);
        }
    }
    public void generateAztecWeaponShops(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) {
        counter = chunkX * 16 + random.nextInt(16);
        Zcoord1 = chunkZ * 16 + random.nextInt(16);
        base = world.getHeightValue(counter, Zcoord1);
        biome = world.getWorldChunkManager().getBiomeGenAt(counter, Zcoord1);
        if (BiomeDictionary.isBiomeOfType(biome, BiomeDictionary.Type.JUNGLE) && !world.provider.hasNoSky && !world.provider.isHellWorld && biome.topBlock == Blocks.grass && world.getBlock(counter, base - 1, Zcoord1) == biome.topBlock) {
            (new AztecWeaponsShopWorldGen()).func_76484_a(world, random, counter, base - 4, Zcoord1);
        }
    }
    public void generateTarSites(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) {
        counter = chunkX * 16 + random.nextInt(16);
        Zcoord1 = chunkZ * 16 + random.nextInt(16);
        base = world.getHeightValue(counter, Zcoord1);
        biome = world.getWorldChunkManager().getBiomeGenAt(counter, Zcoord1);
        if (!world.provider.hasNoSky && !world.provider.isHellWorld && biome.topBlock == Blocks.grass && world.getBlock(counter, base - 1, Zcoord1) == biome.topBlock) {
            (new TarSiteWorldGen()).func_76484_a(world, random, counter, base - 3, Zcoord1);
        }
    }
    public void generateFossilSites(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) {
        counter = chunkX * 16 + random.nextInt(16);
        Zcoord1 = chunkZ * 16 + random.nextInt(16);
        base = world.getHeightValue(counter, Zcoord1);
        biome = world.getWorldChunkManager().getBiomeGenAt(counter, Zcoord1);
    ...
    public void generate2(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) {
        counter = 0;
        counter = counter + 1;
        if (counter == 1) {
    ...
    public void generate3(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) {
        counter = 0;
