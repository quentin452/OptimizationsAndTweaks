            ...
            for (int x = 0; x < 16; ++x) {
                for (int y = 20; y < 84; ++y) {
                    for (int z = 0; z < 16; ++z) {
                        ...
                        } else if (GanysNether.shouldGenerateCrops && rand.nextInt(GanysNether.netherCropRate) == 0 && this.shouldGenerate(world, blockX, blockY, blockZ) && this.hasLavaNearby(world, blockX, blockY - 1, blockZ)) {
