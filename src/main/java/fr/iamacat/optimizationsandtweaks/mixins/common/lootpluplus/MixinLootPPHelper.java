        ...
        try {
            ...
            for (BiomeGenBase biome : biomes) {
                if (biome != null) {
                    ...
                    biomeStringBuilder.append("    - Forge Biome Types: ").append(Arrays.toString(biome.getBiomeClass().getEnumConstants())).append("\n\n");
                }
            }
                ...
                try {
                    ...
                    while (var38.hasNext()) {
                        ...
                        if (itemStack.getItem() instanceof ItemFood) {
                            ...
                            stringBuilder.append("\t- Food or Drink? ").append(action == EnumAction.eat ? "Food" : (action == EnumAction.drink ? "Drink" : "Unknown")).append("\n");
                            stringBuilder.append("\t- Food Amount: ").append(itemFood.func_150905_g(new ItemStack(itemFood))).append("\n");
                            stringBuilder.append("\t- Saturation Amount: ").append(itemFood.func_150906_h(new ItemStack(itemFood))).append("\n\n");
