...
public abstract class MixinWorldGenMassiveTree extends WorldGenerator {
    ...
    private boolean optimizationsAndTweaks$shouldBreakLoop(Block block, int x, int y, int z) {
        if (this.safeGrowth) {
            return !(block.isAir(this.worldObj, x, y, z) || block.isReplaceable(this.worldObj, x, y, z)
                || block.canBeReplacedByLeaves(this.worldObj, x, y, z)
                || block.isLeaves(this.worldObj, x, y, z)
    ...
    private static final int sinc2(double var0, double var2, int var4) {
        ...
        return var9 == 0.0 ? var4
            : (int) Math.round(
                var4 * ((Math.sin(var9) / var9 + Math.sin(var9 * 2.0943951023931953) / (var9 * 2.0943951023931953))
                    / 2.0));
    }
     ...
     * at powercrystals.minefactoryreloaded.world.WorldGenMassiveTree.genLeafLayer(WorldGenMassiveTree.java:182)
     * ~[WorldGenMassiveTree.class:?]
     * at powercrystals.minefactoryreloaded.world.WorldGenMassiveTree.generateLeaves(WorldGenMassiveTree.java:214)
     * ~[WorldGenMassiveTree.class:?]
     * at powercrystals.minefactoryreloaded.world.WorldGenMassiveTree.func_76484_a(WorldGenMassiveTree.java:813)
     * ~[WorldGenMassiveTree.class:?]
     * at
     * powercrystals.minefactoryreloaded.world.MineFactoryReloadedWorldGen.optimizationsAndTweaks$generateMegaRubberTree
     * (MineFactoryReloadedWorldGen.java:562) ~[MineFactoryReloadedWorldGen .class:?]
     * at
     * powercrystals.minefactoryreloaded.world.MineFactoryReloadedWorldGen.generateFeature(MineFactoryReloadedWorldGen.
     * java:612) ~[MineFactoryReloadedWorldGen.class:?]
            ...
            for (int var11 = 0; var11 <= var4; ++var11) {
                ...
                while (true) {
                    label40: {
                        ...
                        if (this.safeGrowth) {
                            if (!var13.isAir(this.worldObj, var1, var2, var3)
                                && !var13.isLeaves(this.worldObj, var1, var2, var3)
                                && !var13.canBeReplacedByLeaves(this.worldObj, var1, var2, var3)) {
                                break label40;
                            }
        ...
        for (int var9 = -this.trunkSize; var9 <= this.trunkSize; ++var9) {
            ...
            for (int var10 = -this.trunkSize; var10 <= this.trunkSize; ++var10) {
                if ((var10 * var10 + var9 * var9) * 4 < this.trunkSize * this.trunkSize * 5) {
                    ...
                    this.worldObj.getBlock(var5[0], var5[1] - 1, var5[2])
                        .onPlantGrow(this.worldObj, var5[0], var5[1] - 1, var5[2], var1, var2, var4);
                }
            }
        }
    }
