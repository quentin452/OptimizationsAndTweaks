...
public class MixinBiomeRegistry {
    ...
    public static void registerBiome() {
        safeShallows = (new BiomeGenSafeShallows(MinenauticaBiomeIDConfig.safeShallows)).setBiomeName("Safe Shallows").setHeight(new BiomeGenBase.Height(-0.4F, 0.3F));
        grassyPlateaus = (new BiomeGenGrassyPlateaus(MinenauticaBiomeIDConfig.grassyPlateaus)).setBiomeName("Grassy Plateaus").setHeight(new BiomeGenBase.Height(-1.4F, 0.2F));
        kelpForest = (new BiomeGenKelpForest(MinenauticaBiomeIDConfig.kelpForest)).setBiomeName("Kelp Forest").setHeight(new BiomeGenBase.Height(-1.9F, 0.45F));
    }
    /**
     * @author
     * @reason
