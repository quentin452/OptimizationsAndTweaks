...
public class MixinMSEvents {
    ...
    public void onEntityDrop(LivingDropsEvent event) {
        if (MSConfig.hostileDrop && event.entityLiving instanceof IMob && event.source.getDamageType().equals("player") && !(event.source.getEntity() instanceof FakePlayer) && rand.nextDouble() <= Patcher.stoneDropRate) {
