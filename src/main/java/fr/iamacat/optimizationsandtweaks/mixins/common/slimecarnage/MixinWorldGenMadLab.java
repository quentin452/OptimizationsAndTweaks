...
public class MixinWorldGenMadLab {
    ...
    public void optimizationsAndTweaks$generate2(World world, Random rand, int i, int j, int k) {
        ...
        world.setBlock(i, j - 7, k + 4, Blocks.stone);
        world.setBlock(i, j - 8, k + 4, Blocks.stone);
        world.setBlock(i, j - 9, k + 4, Blocks.stone);
        world.setBlock(i - 3, j - 7, k + 7, Blocks.stone);
        world.setBlock(i - 3, j - 8, k + 7, Blocks.stone);
        world.setBlock(i - 3, j - 9, k + 7, Blocks.stone);
        world.setBlock(i, j - 7, k + 7, Blocks.stone);
        world.setBlock(i, j - 8, k + 7, Blocks.stone);
        world.setBlock(i, j - 9, k + 7, Blocks.stone);
        ...
        world.setBlock(i, j - 7, k + 5, Blocks.iron_bars);
        world.setBlock(i, j - 8, k + 5, Blocks.iron_bars);
        world.setBlock(i, j - 9, k + 5, Blocks.iron_bars);
        ...
        world.setBlock(i, j - 7, k + 6, Blocks.iron_bars);
        world.setBlock(i, j - 8, k + 6, Blocks.iron_bars);
        world.setBlock(i, j - 9, k + 6, Blocks.iron_bars);
        ...
        world.setBlock(i, j - 7, k + 10, Blocks.stone);
        world.setBlock(i, j - 8, k + 10, Blocks.stone);
        world.setBlock(i, j - 9, k + 10, Blocks.stone);
        world.setBlock(i - 3, j - 7, k + 13, Blocks.stone);
        world.setBlock(i - 3, j - 8, k + 13, Blocks.stone);
        world.setBlock(i - 3, j - 9, k + 13, Blocks.stone);
        world.setBlock(i, j - 7, k + 13, Blocks.stone);
        world.setBlock(i, j - 8, k + 13, Blocks.stone);
        world.setBlock(i, j - 9, k + 13, Blocks.stone);
        ...
        world.setBlock(i, j - 7, k + 11, Blocks.iron_bars);
        world.setBlock(i, j - 8, k + 11, Blocks.iron_bars);
        world.setBlock(i, j - 9, k + 11, Blocks.iron_bars);
        ...
        world.setBlock(i, j - 7, k + 12, Blocks.iron_bars);
        world.setBlock(i, j - 8, k + 12, Blocks.iron_bars);
        world.setBlock(i, j - 9, k + 12, Blocks.iron_bars);
