...
public abstract class BaseAbstractUnivariateIntegrator implements UnivariateIntegrator {
     ...
     */
    @Deprecated
    protected fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.util.Incrementor iterations;
     ...
     * like {@link fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.util.Precision#SAFE_MIN
    ...
    protected BaseAbstractUnivariateIntegrator(final double relativeAccuracy, final double absoluteAccuracy,
        ...
        this.count = IntegerSequence.Incrementor.create()
            .withMaximalCount(maximalIterationCount);

        @SuppressWarnings("deprecation")
        fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.util.Incrementor wrapped = fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.util.Incrementor
            .wrap(count);
