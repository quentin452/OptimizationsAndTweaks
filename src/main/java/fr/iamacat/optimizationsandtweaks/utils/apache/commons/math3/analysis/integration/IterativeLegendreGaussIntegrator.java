...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.analysis.integration.gauss.GaussIntegrator;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.analysis.integration.gauss.GaussIntegratorFactory;
...
public class IterativeLegendreGaussIntegrator extends BaseAbstractUnivariateIntegrator {
    ...
    public IterativeLegendreGaussIntegrator(final int n, final int minimalIterationCount,
        final int maximalIterationCount) throws NotStrictlyPositiveException, NumberIsTooSmallException {
