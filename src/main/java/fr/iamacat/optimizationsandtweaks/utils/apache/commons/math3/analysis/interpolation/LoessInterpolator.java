...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.analysis.polynomials.PolynomialSplineFunction;
...
public class LoessInterpolator implements UnivariateInterpolator, Serializable {
     ...
     * with a
     * {@link fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.analysis.interpolation.SplineInterpolator}
    ...
    public final PolynomialSplineFunction interpolate(final double[] xval, final double[] yval)
        throws NonMonotonicSequenceException, DimensionMismatchException, NoDataException, NotFiniteNumberException,
