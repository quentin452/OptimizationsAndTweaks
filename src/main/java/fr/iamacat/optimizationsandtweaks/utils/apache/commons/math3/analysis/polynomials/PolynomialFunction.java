 ...
 */
package fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.analysis.polynomials;

import java.io.Serializable;
import java.util.Arrays;

import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.analysis.DifferentiableUnivariateFunction;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.analysis.differentiation.UnivariateDifferentiableFunction;
...
public class PolynomialFunction
    ...
    public PolynomialFunction add(final PolynomialFunction p) {
        ...
        System.arraycopy(
            (coefficients.length < p.coefficients.length) ? p.coefficients : coefficients,
            lowLength,
            newCoefficients,
            lowLength,
    ...
    public PolynomialFunction multiply(final PolynomialFunction p) {
        ...
        for (int i = 0; i < newCoefficients.length; ++i) {
            ...
            for (int j = FastMath.max(0, i + 1 - p.coefficients.length); j
                < FastMath.min(coefficients.length, i + 1); ++j) {
