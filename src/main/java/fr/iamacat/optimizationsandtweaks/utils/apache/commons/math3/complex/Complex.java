...
package fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.complex;
 ...
 * {@link fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.util.Precision#equals(double,double,int)
 * equals for primitive double} in {@link fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.util.Precision}
...
public class Complex implements FieldElement<Complex>, Serializable {
    ...
    public Complex asin() {
        ...
        return sqrt1z().add(this.multiply(I))
            .log()
            .multiply(I.negate());
    }
    ...
    public Complex sqrt1z() {
        return createComplex(1.0, 0.0).subtract(this.multiply(this))
            .sqrt();
    }
