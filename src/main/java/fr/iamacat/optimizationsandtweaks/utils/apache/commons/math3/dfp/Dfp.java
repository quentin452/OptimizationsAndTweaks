...
package fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.dfp;
 ...
 * which is 10<sup>4</sup>, so its almost decimal.
 * </p>
 *
 * <p>
...
public class Dfp implements RealFieldElement<Dfp> {
    ...
    /**
     * Get the {@link Field Field} (really a {@link DfpField}) to which the instance belongs.
     * <p>
     * The field is linked to the number of digits and acts as a factory
     * for {@link Dfp} instances.
     * </p>
     *
     * @return {@link Field Field} (really a {@link DfpField}) to which the instance belongs
     */
    ...
    public Dfp remainder(final Dfp d) {
        ...
        final Dfp result = this.subtract(
            this.divide(d)
                .rint()
                .multiply(d));
    ...
    public Dfp hypot(final Dfp y) {
        return multiply(this).add(y.multiply(y))
            .sqrt();
    }
    ...
    public Dfp rootN(final int n) {
        return (sign >= 0) ? DfpMath.pow(this, getOne().divide(n))
    ...
    public Dfp tanh() {
        ...
        return ePlus.subtract(eMinus)
            .divide(ePlus.add(eMinus));
    }
     ...
     */
    public Dfp acosh() {
        return multiply(this).subtract(getOne())
            .sqrt()
            .add(this)
            .log();
    }
     ...
     */
    public Dfp asinh() {
        return multiply(this).add(getOne())
            .sqrt()
            .add(this)
            .log();
    }
     ...
     */
    public Dfp atanh() {
        return getOne().add(this)
            .divide(getOne().subtract(this))
            .log()
            .divide(2);
    }
     ...
     * @since 3.2
     */
    public Dfp linearCombination(final double a1, final Dfp b1, final double a2, final Dfp b2, final double a3,
        final Dfp b3) {
        return b1.multiply(a1)
            .add(b2.multiply(a2))
            .add(b3.multiply(a3));
     ...
     */
    public Dfp linearCombination(final double a1, final Dfp b1, final double a2, final Dfp b2, final double a3,
        final Dfp b3, final double a4, final Dfp b4) {
        return b1.multiply(a1)
            .add(b2.multiply(a2))
            .add(b3.multiply(a3))
            .add(b4.multiply(a4));
