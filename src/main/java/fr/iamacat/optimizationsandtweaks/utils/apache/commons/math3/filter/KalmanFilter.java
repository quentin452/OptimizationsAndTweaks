 ...
 */
package fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.filter;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.linear.MatrixDimensionMismatchException;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.linear.MatrixUtils;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.linear.NonSquareMatrixException;
...
public class KalmanFilter {
     ...
     *                                          if the column dimension of the transition matrix does not match the
     *                                          dimension of the
    ...
    public KalmanFilter(final ProcessModel process, final MeasurementModel measurement) throws NullArgumentException,
        NonSquareMatrixException, DimensionMismatchException, MatrixDimensionMismatchException {
