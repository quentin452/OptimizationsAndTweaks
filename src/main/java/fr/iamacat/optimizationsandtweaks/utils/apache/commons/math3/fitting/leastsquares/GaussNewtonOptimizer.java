...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.linear.CholeskyDecomposition;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.linear.LUDecomposition;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.linear.MatrixUtils;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.linear.NonPositiveDefiniteMatrixException;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.linear.SingularMatrixException;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.linear.SingularValueDecomposition;
...
public class GaussNewtonOptimizer implements LeastSquaresOptimizer {
    ...
    public enum Decomposition {
         ...
         *
         * <p>
         * Theoretically this method takes mn<sup>2</sup>/2 operations to compute the
        ...
        LU {
            ...
            protected RealVector solve(final RealMatrix jacobian, final RealVector residuals) {
                try {
                    ...
                    return new LUDecomposition(normal, SINGULARITY_THRESHOLD).getSolver()
                        .solve(jTr);
         ...
         *
         * <p>
         * Theoretically this method takes mn<sup>2</sup> - n<sup>3</sup>/3 operations
        ...
        QR {
            ...
            protected RealVector solve(final RealMatrix jacobian, final RealVector residuals) {
                try {
                    return new QRDecomposition(jacobian, SINGULARITY_THRESHOLD).getSolver()
                        .solve(residuals);
                } catch (SingularMatrixException e) {
                    throw new ConvergenceException(LocalizedFormats.UNABLE_TO_SOLVE_SINGULAR_PROBLEM, e);
                }
        ...
        CHOLESKY {
            ...
            protected RealVector solve(final RealMatrix jacobian, final RealVector residuals) {
                try {
                    ...
                    final RealMatrix normal = normalEquation.getFirst();
                    final RealVector jTr = normalEquation.getSecond();
                    return new CholeskyDecomposition(normal, SINGULARITY_THRESHOLD, SINGULARITY_THRESHOLD).getSolver()
                        .solve(jTr);
        ...
        SVD {
            ...
            @Override
            protected RealVector solve(final RealMatrix jacobian, final RealVector residuals) {
                return new SingularValueDecomposition(jacobian).getSolver()
                    .solve(residuals);
            }
        };
