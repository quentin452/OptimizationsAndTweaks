...
public class OutlineExtractor {
    ...
    private class BoundaryProjector implements BSPTreeVisitor<Euclidean3D> {
        ...
        private void addContribution(final SubHyperplane<Euclidean3D> facet, final boolean reversed) {
            ...
            final double scal = plane.getNormal()
                .dotProduct(w);
            if (FastMath.abs(scal) > 1.0e-3) {
                ...
                for (Vector2D[] loop : vertices) {
                    ...
                    while (current < loop.length) {
                        ...
                        final fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.geometry.euclidean.twod.Line line = new fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.geometry.euclidean.twod.Line(
                            pPoint,
                            cPoint,
                            tolerance);
                        ...
                        if (closed || (previous != 1)) {
                            ...
                            final fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.geometry.euclidean.twod.Line l = new fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.geometry.euclidean.twod.Line(
                                pPoint,
                                angle,
                                tolerance);
                            edge = edge.split(l)
