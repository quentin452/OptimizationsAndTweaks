    ...
    public double[] getAngles(RotationOrder order, RotationConvention convention)
        ...
        if (convention == RotationConvention.VECTOR_OPERATOR) {
            ...
            if (order == RotationOrder.XYZ) {
                ...
                return new double[] { FastMath.atan2(-v2.getY(), v2.getZ()), FastMath.asin(v2.getX()),
                ...
                return new double[] { FastMath.atan2(v2.getZ(), v2.getY()), -FastMath.asin(v2.getX()),
                ...
                return new double[] { FastMath.atan2(v2.getX(), v2.getZ()), -FastMath.asin(v2.getY()),
                ...
                return new double[] { FastMath.atan2(-v2.getZ(), v2.getX()), FastMath.asin(v2.getY()),
                ...
                return new double[] { FastMath.atan2(-v2.getX(), v2.getY()), FastMath.asin(v2.getZ()),
                ...
                return new double[] { FastMath.atan2(v2.getY(), v2.getX()), -FastMath.asin(v2.getZ()),
                ...
                return new double[] { FastMath.atan2(v2.getY(), -v2.getZ()), FastMath.acos(v2.getX()),
                    FastMath.atan2(v1.getY(), v1.getZ()) };
                ...
                return new double[] { FastMath.atan2(v2.getZ(), v2.getY()), FastMath.acos(v2.getX()),
                    FastMath.atan2(v1.getZ(), -v1.getY()) };
                ...
                return new double[] { FastMath.atan2(v2.getX(), v2.getZ()), FastMath.acos(v2.getY()),
                    FastMath.atan2(v1.getX(), -v1.getZ()) };
                ...
                return new double[] { FastMath.atan2(v2.getZ(), -v2.getX()), FastMath.acos(v2.getY()),
                    FastMath.atan2(v1.getZ(), v1.getX()) };
                ...
                return new double[] { FastMath.atan2(v2.getX(), -v2.getY()), FastMath.acos(v2.getZ()),
                    FastMath.atan2(v1.getX(), v1.getY()) };
                ...
                return new double[] { FastMath.atan2(v2.getY(), v2.getX()), FastMath.acos(v2.getZ()),
                    FastMath.atan2(v1.getY(), -v1.getX()) };
