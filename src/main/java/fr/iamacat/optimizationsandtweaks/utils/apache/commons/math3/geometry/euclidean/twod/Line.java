...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.geometry.Vector;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.geometry.euclidean.oned.OrientedPoint;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.geometry.euclidean.oned.Vector1D;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.geometry.partitioning.Embedding;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.geometry.partitioning.Transform;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.util.MathUtils;
...
public class Line implements Hyperplane<Euclidean2D>, Embedding<Euclidean2D, Euclidean1D> {
    ...
    public Line getReverse() {
        if (reverse == null) {
            reverse = new Line(
                (angle < FastMath.PI) ? (angle + FastMath.PI) : (angle - FastMath.PI),
                -cos,
                -sin,
                -originOffset,
                tolerance);
    ...
    public Vector2D toSpace(final Point<Euclidean1D> point) {
        ...
        return new Vector2D(
            MathArrays.linearCombination(abscissa, cos, -originOffset, sin),
    ...
    public Vector2D intersection(final Line other) {
        ...
        return new Vector2D(
            MathArrays.linearCombination(cos, other.originOffset, -other.cos, originOffset) / d,
    ...
    public Vector2D getPointAt(final Vector1D abscissa, final double offset) {
        ...
        return new Vector2D(
            MathArrays.linearCombination(x, cos, dOffset, sin),
     ...
     * fr.iamacat.multithreading.utils.apache.commons.math3.geometry.euclidean.threed.Line class.
     * </p>
     *
     * @param p to check
    ...
    /**
     * Get a {@link fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.geometry.partitioning.Transform
     * Transform} embedding an affine transform.
     *
     * @param transform affine transform to embed (must be inversible
     *                  otherwise the {@link
     *                  fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.geometry.partitioning.Transform#apply(Hyperplane)
     *                  apply(Hyperplane)} method would work only for some lines, and
     *                  fail for other ones)
     * @return a new transform that can be applied to either {@link
     *         Vector2D Vector2D}, {@link Line Line} or {@link
     *         fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.geometry.partitioning.SubHyperplane
     ...
     * @since 3.6
     */
    public static Transform<Euclidean2D, Euclidean1D> getTransform(final double cXX, final double cYX, final double cXY,
        final double cYY, final double cX1, final double cY1) throws MathIllegalArgumentException {
    ...
    private static class LineTransform implements Transform<Euclidean2D, Euclidean1D> {
         ...
         * @since 3.6
         */
        LineTransform(final double cXX, final double cYX, final double cXY, final double cYY, final double cX1,
            final double cY1) throws MathIllegalArgumentException {
        ...
        public Vector2D apply(final Point<Euclidean2D> point) {
            ...
            return new Vector2D(
                MathArrays.linearCombination(cXX, x, cXY, y, cX1, 1),
        ...
        public Line apply(final Hyperplane<Euclidean2D> hyperplane) {
            ...
            return new Line(
                FastMath.PI + FastMath.atan2(-rSin, -rCos),
                inv * rCos,
                inv * rSin,
                inv * rOffset,
                line.tolerance);
        ...
        public SubHyperplane<Euclidean1D> apply(final SubHyperplane<Euclidean1D> sub,
            final Hyperplane<Euclidean2D> original, final Hyperplane<Euclidean2D> transformed) {
