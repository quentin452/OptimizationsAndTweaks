...
package fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.linear;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.analysis.function.Add;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.analysis.function.Divide;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.analysis.function.Multiply;
 ...
 * <pre>
 *
 * RealVector result = v.mapAddToSelf(3.4)
 *     .mapToSelf(new Tan())
 *     .mapToSelf(new Power(2.3));
 * </pre>
 *
 * @since 2.1
 */
public abstract class RealVector {
     ...
     * <p>
     * The L<sub>&infin;</sub> norm is the max of the absolute
     * values of the elements.
     * </p>
     *
     * @return the norm.
     ...
     *
     * <p>
     * Note: derived classes are required to return an {@link Iterator} that
     ...
     * @since 3.1
     */
    public double walkInDefaultOrder(final RealVectorChangingVisitor visitor, final int start, final int end)
        throws NumberIsTooSmallException, OutOfRangeException {
        checkIndices(start, end);
        visitor.start(getDimension(), start, end);
        for (int i = start; i <= end; i++) {
     ...
     * @since 3.1
     */
    public double walkInOptimizedOrder(final RealVectorChangingVisitor visitor, final int start, final int end)
        throws NumberIsTooSmallException, OutOfRangeException {
        return walkInDefaultOrder(visitor, start, end);
    }
