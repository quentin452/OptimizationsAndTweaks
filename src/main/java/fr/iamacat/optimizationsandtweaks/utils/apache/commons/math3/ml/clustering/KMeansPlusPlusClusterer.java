...
package fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.ml.clustering;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.ml.distance.EuclideanDistance;
...
public class KMeansPlusPlusClusterer<T extends Clusterable> extends Clusterer<T> {
     ...
     */
    public KMeansPlusPlusClusterer(final int k, final int maxIterations, final DistanceMeasure measure,
        final RandomGenerator random, final EmptyClusterStrategy emptyStrategy) {
        super(measure);
        this.k = k;
    ...
    private T getPointFromLargestNumberCluster(final Collection<? extends Cluster<T>> clusters)
        ...
        for (final Cluster<T> cluster : clusters) {
            ...
            final int number = cluster.getPoints()
                .size();
    ...
    private T getFarthestPoint(final Collection<CentroidCluster<T>> clusters) throws ConvergenceException {
        ...
        return selectedCluster.getPoints()
