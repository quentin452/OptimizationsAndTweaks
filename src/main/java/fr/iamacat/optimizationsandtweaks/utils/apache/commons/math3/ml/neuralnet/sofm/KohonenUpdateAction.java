...
package fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.ml.neuralnet.sofm;

import java.util.Collection;
import java.util.HashSet;
import java.util.concurrent.atomic.AtomicLong;

import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.analysis.function.Gaussian;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.ml.neuralnet.MapUtils;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.ml.neuralnet.UpdateAction;
...
public class KohonenUpdateAction implements UpdateAction {
     ...
     */
    public KohonenUpdateAction(DistanceMeasure distance, LearningFactorFunction learningFactor,
    ...
    private double[] computeFeatures(double[] current, double[] sample, double learningRate) {
        ...
        // c + learningRate * (s - c)
        return s.subtract(c)
            .mapMultiplyToSelf(learningRate)
            .add(c)
            .toArray();
    }
}
