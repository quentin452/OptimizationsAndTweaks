...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.analysis.solvers.BracketingNthOrderBrentSolver;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.ode.events.EventState;
...
public abstract class AbstractIntegrator implements FirstOrderIntegrator {
     ...
     */
    @Deprecated
    protected fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.util.Incrementor getEvaluationsCounter() {
        return fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.util.Incrementor.wrap(evaluations);
    }
     ...
     * #getCurrentSignedStepsize()}), it is <em>not</em> thread-safe.
     * </p>
     *
     ...
     *                                       {@link #integrate(ExpandableStatefulODE, double)} or {@link
     ...
     * @since 2.2
     */
    protected double acceptStep(final AbstractStepInterpolator interpolator, final double[] y, final double[] yDot,
        final double tEnd) throws MaxCountExceededException, DimensionMismatchException, NoBracketingException {
