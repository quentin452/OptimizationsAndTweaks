 ...
 * fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.ode.nonstiff.AdaptiveStepsizeIntegrator adaptive
...
public class ContinuousOutputModel implements StepHandler, Serializable {
     ...
     * <p>
     * This method should <strong>not</strong> be called before the
    ...
    public void setInterpolatedTime(final double time) {
        ...
        while (iMax - iMin > 5) {
            ...
            if ((FastMath.abs(tMed - tMin) < 1e-6) || (FastMath.abs(tMax - tMed) < 1e-6)) {
                ...
                final double iLagrange = ((dt2 * dt3 * d23) * iMax - (dt1 * dt3 * d13) * iMed
     ...
     *                            fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.ode.ExpandableStatefulODE#addSecondaryEquations(
     *                            fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.ode.SecondaryEquations)
    ...
    public double[] getInterpolatedSecondaryState(final int secondaryStateIndex) throws MaxCountExceededException {
        return steps.get(index)
            .getInterpolatedSecondaryState(secondaryStateIndex);
    }
    ...
    public double[] getInterpolatedSecondaryDerivatives(final int secondaryStateIndex)
        ...
        return steps.get(index)
            .getInterpolatedSecondaryDerivatives(secondaryStateIndex);
    }
