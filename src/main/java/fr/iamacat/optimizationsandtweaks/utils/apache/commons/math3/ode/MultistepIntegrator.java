...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.ode.nonstiff.AdaptiveStepsizeIntegrator;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.ode.nonstiff.DormandPrince853Integrator;
 ...
 * </p>
 *
 * @see fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.ode.nonstiff.AdamsBashforthIntegrator
 * @see fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.ode.nonstiff.AdamsMoultonIntegrator
 * @since 2.0
 */
public abstract class MultistepIntegrator extends AdaptiveStepsizeIntegrator {
     ...
     */
    protected MultistepIntegrator(final String name, final int nSteps, final int order, final double minStep,
    ...
    public interface NordsieckTransformer {
         ...
         *         h<sup>3</sup>/6 y'''<sub>n</sub> ... h<sup>k</sup>/k! y<sup>(k)</sup><sub>n</sub>)
         */
        Array2DRowRealMatrix initializeHighOrderDerivatives(final double h, final double[] t, final double[][] y,
            final double[][] yDot);
    }
