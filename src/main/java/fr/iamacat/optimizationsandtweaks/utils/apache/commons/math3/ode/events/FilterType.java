...
public enum FilterType {
     ...
     * its {@code increasing} argument set to false.
     * </p>
     */
    TRIGGER_ONLY_DECREASING_EVENTS {
         ...
         * <li>h = -g</li>
         * </ul>
         * where s is a tiny positive value:
         * {@link fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.util.Precision#SAFE_MIN}.
         * </p>
         */
        @Override
     ...
     * event handler} {@link EventHandler#eventOccurred(double, double[],
     * boolean) eventOccurred} method will be called <em>only</em> with
     * its {@code increasing} argument set to true.
     * </p>
     */
