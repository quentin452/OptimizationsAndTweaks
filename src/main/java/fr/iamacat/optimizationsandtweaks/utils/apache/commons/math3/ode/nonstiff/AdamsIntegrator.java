...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.ode.MultistepIntegrator;
...
public abstract class AdamsIntegrator extends MultistepIntegrator {
     ...
     */
    public AdamsIntegrator(final String name, final int nSteps, final int order, final double minStep,
    ...
    /** {@inheritDoc} */
    @Override
    protected Array2DRowRealMatrix initializeHighOrderDerivatives(final double h, final double[] t, final double[][] y,
        final double[][] yDot) {
