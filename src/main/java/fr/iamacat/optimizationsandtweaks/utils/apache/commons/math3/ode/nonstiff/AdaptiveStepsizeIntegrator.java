 ...
 * fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.ode.FirstOrderDifferentialEquations basic ODE}, then
...
public abstract class AdaptiveStepsizeIntegrator extends AbstractIntegrator {
     ...
     */
    public AdaptiveStepsizeIntegrator(final String name, final double minStep, final double maxStep,
    ...
    protected void sanityChecks(final ExpandableStatefulODE equations, final double t)
        ...
        mainSetDimension = equations.getPrimaryMapper()
            .getDimension();
     ...
     */
    public double initializeStep(final boolean forward, final int order, final double[] scale, final double t0,
        ...
        final double h1 = (maxInv2 < 1.0e-15) ? FastMath.max(1.0e-6, 0.001 * FastMath.abs(h))
