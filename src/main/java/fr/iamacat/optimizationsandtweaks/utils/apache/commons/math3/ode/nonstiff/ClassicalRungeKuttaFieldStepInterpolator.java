...
class ClassicalRungeKuttaFieldStepInterpolator<T extends RealFieldElement<T>>
     ...
     */
    ClassicalRungeKuttaFieldStepInterpolator(final Field<T> field, final boolean forward, final T[][] yDotK,
    ...
    /** {@inheritDoc} */
    @Override
    protected ClassicalRungeKuttaFieldStepInterpolator<T> create(final Field<T> newField, final boolean newForward,
    ...
    protected FieldODEStateAndDerivative<T> computeInterpolatedStateAndDerivatives(final FieldEquationsMapper<T> mapper,
        ...
        final T coeffDot23 = theta.multiply(oneMinusTheta)
            .multiply(2);
        final T coeffDot4 = theta.multiply(oneMinus2Theta)
            .negate();
        ...
        if (getGlobalPreviousState() != null && theta.getReal() <= 0.5) {
            ...
            final T coeff1 = s.multiply(
                theta.multiply(
                    ...
                    .subtract(1));
            final T coeff23 = s.multiply(
                theta.multiply(fourTheta.subtract(2))
                    .subtract(2));
