...
public class DormandPrince54FieldIntegrator<T extends RealFieldElement<T>>
     ...
     */
    public DormandPrince54FieldIntegrator(final Field<T> field, final double minStep, final double maxStep,
    ...
    /** {@inheritDoc} */
    @Override
    protected DormandPrince54FieldStepInterpolator<T> createInterpolator(final boolean forward, T[][] yDotK,
    ...
    protected T estimateError(final T[][] yDotK, final T[] y0, final T[] y1, final T h) {
        ...
        for (int j = 0; j < mainSetDimension; ++j) {
            ...
            final T ratio = h.multiply(errSum)
                .divide(tol);
