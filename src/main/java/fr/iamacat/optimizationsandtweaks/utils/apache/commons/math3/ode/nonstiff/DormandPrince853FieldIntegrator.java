...
public class DormandPrince853FieldIntegrator<T extends RealFieldElement<T>>
     ...
     */
    public DormandPrince853FieldIntegrator(final Field<T> field, final double minStep, final double maxStep,
    ...
    public T[][] getA() {
        ...
        a[3][0] = sqrt6.multiply(107)
            .add(462)
            .divide(3000);
        a[3][1] = getField().getZero();
        a[3][2] = sqrt6.multiply(197)
            .add(402)
            .divide(-1000);
        a[3][3] = sqrt6.multiply(73)
            .add(168)
            .divide(375);
        ...
        a[5][3] = sqrt6.multiply(23)
            .add(118)
            .divide(1024);
        a[5][4] = sqrt6.multiply(-23)
            .add(118)
            .divide(1024);
        ...
        a[6][3] = sqrt6.multiply(4784)
            .add(51544)
            .divide(371293);
        a[6][4] = sqrt6.multiply(-4784)
            .add(51544)
            .divide(371293);
        ...
        a[7][3] = sqrt6.multiply(-318801444819.0)
            .add(-1324889724104.0)
            .divide(626556937500.0);
        a[7][4] = sqrt6.multiply(318801444819.0)
            .add(-1324889724104.0)
            .divide(626556937500.0);
        ...
        a[8][3] = sqrt6.multiply(-1137963.0)
            .add(-4521408.0)
            .divide(2937500.0);
        a[8][4] = sqrt6.multiply(1137963.0)
            .add(-4521408.0)
            .divide(2937500.0);
        ...
        a[9][3] = sqrt6.multiply(94326.0)
            .add(354216.0)
            .divide(112847.0);
        a[9][4] = sqrt6.multiply(-94326.0)
            .add(354216.0)
            .divide(112847.0);
        ...
        a[10][3] = sqrt6.multiply(-960905.0)
            .add(-3457480.0)
            .divide(551636.0);
        a[10][4] = sqrt6.multiply(960905.0)
            .add(-3457480.0)
            .divide(551636.0);
    ...
    /** {@inheritDoc} */
    @Override
    protected DormandPrince853FieldStepInterpolator<T> createInterpolator(final boolean forward, T[][] yDotK,
        final FieldODEStateAndDerivative<T> globalPreviousState, final FieldODEStateAndDerivative<T> globalCurrentState,
        final FieldEquationsMapper<T> mapper) {
        return new DormandPrince853FieldStepInterpolator<T>(
            getField(),
            forward,
            yDotK,
            globalPreviousState,
    ...
    protected T estimateError(final T[][] yDotK, final T[] y0, final T[] y1, final T h) {
        ...
        for (int j = 0; j < mainSetDimension; ++j) {
            ...
            final T tol = vecAbsoluteTolerance == null ? yScale.multiply(scalRelativeTolerance)
                ...
                : yScale.multiply(vecRelativeTolerance[j])
                    .add(vecAbsoluteTolerance[j]);
