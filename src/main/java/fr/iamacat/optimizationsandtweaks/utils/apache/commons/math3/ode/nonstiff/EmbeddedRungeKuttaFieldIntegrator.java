 ...
 *
 * <p>
 * Some methods are qualified as <i>fsal</i> (first same as last)
        ...
        do {
            ...
            while (error.subtract(1.0)
                ...
                if (firstTime) {
                    ...
                    if (vecAbsoluteTolerance == null) {
                        for (int i = 0; i < scale.length; ++i) {
                            scale[i] = y[i].abs()
                                .multiply(scalRelativeTolerance)
                                .add(scalAbsoluteTolerance);
                        }
                    } else {
                        for (int i = 0; i < scale.length; ++i) {
                            scale[i] = y[i].abs()
                                .multiply(vecRelativeTolerance[i])
                ...
                if (error.subtract(1.0)
                    ...
                    final T factor = MathUtils
                        .min(maxGrowth, MathUtils.max(minReduction, safety.multiply(error.pow(exp))));
