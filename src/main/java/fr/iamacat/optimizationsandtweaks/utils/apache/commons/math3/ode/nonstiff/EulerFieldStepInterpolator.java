...
class EulerFieldStepInterpolator<T extends RealFieldElement<T>> extends RungeKuttaFieldStepInterpolator<T> {
     ...
     */
    EulerFieldStepInterpolator(final Field<T> field, final boolean forward, final T[][] yDotK,
    ...
    /** {@inheritDoc} */
    @Override
    protected EulerFieldStepInterpolator<T> create(final Field<T> newField, final boolean newForward,
        ...
        return new EulerFieldStepInterpolator<T>(
            newField,
            newForward,
            newYDotK,
