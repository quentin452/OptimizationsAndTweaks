...
class GillFieldStepInterpolator<T extends RealFieldElement<T>> extends RungeKuttaFieldStepInterpolator<T> {
     ...
     */
    GillFieldStepInterpolator(final Field<T> field, final boolean forward, final T[][] yDotK,
        ...
        super(
            ...
            softCurrentState,
            mapper);
        final T sqrt = field.getZero()
            .add(0.5)
            .sqrt();
        one_minus_inv_sqrt_2 = field.getOne()
            .subtract(sqrt);
        one_plus_inv_sqrt_2 = field.getOne()
            .add(sqrt);
    }

    /** {@inheritDoc} */
    @Override
    protected GillFieldStepInterpolator<T> create(final Field<T> newField, final boolean newForward,
        ...
        return new GillFieldStepInterpolator<T>(
            newField,
            newForward,
            newYDotK,
    ...
    protected FieldODEStateAndDerivative<T> computeInterpolatedStateAndDerivatives(final FieldEquationsMapper<T> mapper,
        ...
        final T coeffDot1 = theta.multiply(twoTheta.subtract(3))
            .add(1);
        ...
        if (getGlobalPreviousState() != null && theta.getReal() <= 0.5) {
            ...
            final T c23 = s.multiply(
                theta.multiply(6)
                    .subtract(fourTheta2));
            final T coeff1 = s.multiply(
                fourTheta2.subtract(theta.multiply(9))
                    .add(6));
            ...
            final T c23 = s.multiply(
                twoTheta.add(2)
                    .subtract(fourTheta2));
            final T coeff1 = s.multiply(
                fourTheta2.subtract(theta.multiply(5))
                    .add(1));
            final T coeff2 = c23.multiply(one_minus_inv_sqrt_2);
            final T coeff3 = c23.multiply(one_plus_inv_sqrt_2);
            final T coeff4 = s.multiply(
                fourTheta2.add(theta)
                    .add(1));
