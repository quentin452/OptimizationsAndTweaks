...
class LutherStepInterpolator extends RungeKuttaStepInterpolator {
     ...
     * {@link
     * fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.ode.sampling.AbstractStepInterpolator#reinitialize}
    ...
    protected void computeInterpolatedStateAndDerivatives(final double theta, final double oneMinusThetaH) {
        ...
        final double coeffDot5 = theta * ((833 + 343 * Q) / 150.0
            + theta * ((-637 - 357 * Q) / 30.0 + theta * ((392 + 287 * Q) / 15.0 + theta * (-49 - 49 * Q) / 5.0)));
        final double coeffDot6 = theta * ((833 - 343 * Q) / 150.0
            + theta * ((-637 + 357 * Q) / 30.0 + theta * ((392 - 287 * Q) / 15.0 + theta * (-49 + 49 * Q) / 5.0)));
        ...
        if ((previousState != null) && (theta <= 0.5)) {
            ...
            final double coeff3 = theta
                * (-104 / 15.0 + theta * (320 / 9.0 + theta * (-152 / 3.0 + theta * 112 / 5.0)));
            final double coeff4 = theta
                * (162 / 25.0 + theta * (-162 / 5.0 + theta * (243 / 5.0 + theta * -567 / 25.0)));
            final double coeff5 = theta * ((833 + 343 * Q) / 300.0
                + theta * ((-637 - 357 * Q) / 90.0 + theta * ((392 + 287 * Q) / 60.0 + theta * (-49 - 49 * Q) / 25.0)));
            final double coeff6 = theta * ((833 - 343 * Q) / 300.0
                + theta * ((-637 + 357 * Q) / 90.0 + theta * ((392 - 287 * Q) / 60.0 + theta * (-49 + 49 * Q) / 25.0)));
            ...
            final double coeff1 = -1 / 20.0
                + theta * (19 / 20.0 + theta * (-89 / 20.0 + theta * (151 / 20.0 + theta * -21 / 5.0)));
            final double coeff2 = 0;
            final double coeff3 = -16 / 45.0
                + theta * (-16 / 45.0 + theta * (-328 / 45.0 + theta * (424 / 15.0 + theta * -112 / 5.0)));
            final double coeff4 = theta * (theta * (162 / 25.0 + theta * (-648 / 25.0 + theta * 567 / 25.0)));
            final double coeff5 = -49 / 180.0 + theta * (-49 / 180.0 + theta
                * ((2254 + 1029 * Q) / 900.0 + theta * ((-1372 - 847 * Q) / 300.0 + theta * (49 + 49 * Q) / 25.0)));
            ...
            for (int i = 0; i < interpolatedState.length; ++i) {
                ...
                final double yDot6 = yDotK[5][i];
                final double yDot7 = yDotK[6][i];
                interpolatedState[i] = currentState[i] + oneMinusThetaH * (coeff1 * yDot1 + coeff2 * yDot2
                    + coeff3 * yDot3
                    + coeff4 * yDot4
                    + coeff5 * yDot5
                    + coeff6 * yDot6
