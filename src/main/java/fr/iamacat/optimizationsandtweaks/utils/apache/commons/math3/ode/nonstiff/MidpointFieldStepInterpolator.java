...
class MidpointFieldStepInterpolator<T extends RealFieldElement<T>> extends RungeKuttaFieldStepInterpolator<T> {
     ...
     */
    MidpointFieldStepInterpolator(final Field<T> field, final boolean forward, final T[][] yDotK,
    ...
    /** {@inheritDoc} */
    @Override
    protected MidpointFieldStepInterpolator<T> create(final Field<T> newField, final boolean newForward,
        ...
        return new MidpointFieldStepInterpolator<T>(
            newField,
            newForward,
            newYDotK,
