...
public abstract class RungeKuttaIntegrator extends AbstractIntegrator {
     ...
     */
    protected RungeKuttaIntegrator(final String name, final double[] c, final double[][] a, final double[] b,
     ...
     */
    public double[] singleStep(final FirstOrderDifferentialEquations equations, final double t0, final double[] y0,
        final double t) {
