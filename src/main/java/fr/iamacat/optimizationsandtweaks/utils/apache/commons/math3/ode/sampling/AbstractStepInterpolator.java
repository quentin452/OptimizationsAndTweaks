 ...
 * </p>
 *
 * @see fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.ode.FirstOrderIntegrator
 * @see fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.ode.SecondOrderIntegrator
 * @see StepHandler
 *
 * @since 1.2
 *
...
public abstract class AbstractStepInterpolator implements StepInterpolator {
     ...
     * fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.ode.nonstiff.EmbeddedRungeKuttaIntegrator}
     ...
     */
    protected void reinitialize(final double[] y, final boolean isForward, final EquationsMapper primary,
     ...
     *
     * <p>
     * Once this method has been called, <strong>no</strong> other
     ...
     *
     * <p>
     * <strong>Warning</strong>: since the step interpolator provided
     ...
     *
     * <p>
     * This method calls the protected <code>doFinalize</code> method
     ...
     * should rather reimplement <code>doFinalize</code>.
     * </p>
     *
     * @exception MaxCountExceededException if the number of functions evaluations is exceeded
     *
