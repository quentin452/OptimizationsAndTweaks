 ...
 * </p>
 *
 * @see fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.ode.FirstOrderFieldIntegrator
...
public interface FieldStepHandler<T extends RealFieldElement<T>> {
     ...
     */
    void handleStep(FieldStepInterpolator<T> interpolator, boolean isLast) throws MaxCountExceededException;
