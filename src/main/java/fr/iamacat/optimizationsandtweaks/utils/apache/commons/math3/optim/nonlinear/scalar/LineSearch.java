...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optim.univariate.BracketFinder;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optim.univariate.BrentOptimizer;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optim.univariate.SearchInterval;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optim.univariate.SimpleUnivariateValueChecker;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optim.univariate.UnivariateObjectiveFunction;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optim.univariate.UnivariateOptimizer;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optim.univariate.UnivariatePointValuePair;
...
public class LineSearch {
     ...
     */
    public LineSearch(MultivariateOptimizer optimizer, double relativeTolerance, double absoluteTolerance,
        double initialBracketingRange) {
        mainOptimizer = optimizer;
        lineOptimizer = new BrentOptimizer(
            REL_TOL_UNUSED,
            ABS_TOL_UNUSED,
            new SimpleUnivariateValueChecker(relativeTolerance, absoluteTolerance));
