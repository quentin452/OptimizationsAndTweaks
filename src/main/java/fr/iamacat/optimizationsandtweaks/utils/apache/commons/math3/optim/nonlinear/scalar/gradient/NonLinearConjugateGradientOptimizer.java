...
package fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optim.nonlinear.scalar.gradient;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optim.nonlinear.scalar.GradientMultivariateOptimizer;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optim.nonlinear.scalar.LineSearch;
...
public class NonLinearConjugateGradientOptimizer extends GradientMultivariateOptimizer {
     ...
     *             {@link #NonLinearConjugateGradientOptimizer(Formula,ConvergenceChecker,double,double,double)}
     *             instead.
     */
    @Deprecated
     ...
     */
    public NonLinearConjugateGradientOptimizer(final Formula updateFormula, ConvergenceChecker<PointValuePair> checker,
        double relativeTolerance, double absoluteTolerance, double initialBracketingRange) {
        this(
            updateFormula,
            checker,
            relativeTolerance,
     ...
     * @deprecated as of 3.3. Please use
     *             {@link #NonLinearConjugateGradientOptimizer(Formula,ConvergenceChecker,double,double,double,Preconditioner)}
     *             instead.
     */
    @Deprecated
    public NonLinearConjugateGradientOptimizer(final Formula updateFormula, ConvergenceChecker<PointValuePair> checker,
        final UnivariateSolver lineSearchSolver, final Preconditioner preconditioner) {
        this(
            updateFormula,
            checker,
    ...
    protected PointValuePair doOptimize() {
        ...
        while (true) {
            ...
            final double step = line.search(point, searchDirection)
                .getPoint();
