...
package fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optimization.general;

import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.analysis.DifferentiableMultivariateVectorFunction;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.analysis.FunctionUtils;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.analysis.differentiation.DerivativeStructure;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.analysis.differentiation.MultivariateDifferentiableVectorFunction;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.linear.ArrayRealVector;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.linear.DecompositionSolver;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.linear.DiagonalMatrix;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.linear.EigenDecomposition;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optimization.ConvergenceChecker;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optimization.DifferentiableMultivariateVectorOptimizer;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optimization.InitialGuess;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optimization.OptimizationData;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optimization.PointVectorValuePair;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optimization.Target;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optimization.Weight;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optimization.direct.BaseAbstractMultivariateVectorOptimizer;
 ...
 * {@link fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optimization.Target Target} while
 * the number of columns is equal to the dimension of the
 * {@link fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optimization.InitialGuess InitialGuess}.
 *
...
public abstract class AbstractLeastSquaresOptimizer
     ...
     * fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optimization.SimpleVectorValueChecker}.
     *
     * @deprecated See
     *             {@link fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.optimization.SimpleValueChecker#SimpleValueChecker()}
     */
    @Deprecated
    ...
    protected void updateJacobian() {
        ...
        weightedResidualJacobian = weightedJacobian.scalarMultiply(-1)
            .getData();
    }
    ...
    protected void updateResidualsAndCost() {
        ...
        weightedResiduals = weightMatrixSqrt.operate(residuals)
            .toArray();
    }
    ...
    public double[][] computeCovariances(double[] params, double threshold) {
        ...
        final RealMatrix jTj = j.transpose()
            .multiply(j);
    ...
    @Override
    @Deprecated
    public PointVectorValuePair optimize(int maxEval, final DifferentiableMultivariateVectorFunction f,
     ...
     */
    @Deprecated
    public PointVectorValuePair optimize(final int maxEval, final MultivariateDifferentiableVectorFunction f,
        final double[] target, final double[] weights, final double[] startPoint) {
     ...
     */
    @Deprecated
    protected PointVectorValuePair optimizeInternal(final int maxEval, final MultivariateDifferentiableVectorFunction f,
    ...
    protected void setUp() {
        ...
        jF = FunctionUtils.toMultivariateDifferentiableVectorFunction(
