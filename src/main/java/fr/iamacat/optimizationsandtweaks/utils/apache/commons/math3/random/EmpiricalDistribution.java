...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.AbstractRealDistribution;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.ConstantRealDistribution;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.NormalDistribution;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.stat.descriptive.SummaryStatistics;
...
public class EmpiricalDistribution extends AbstractRealDistribution {
    ...
    protected final fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.random.RandomDataGenerator randomData;
    ...
    public EmpiricalDistribution(int binCount) {
        this(binCount, new fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.random.RandomDataGenerator());
    }
    ...
    @Deprecated
    public EmpiricalDistribution(int binCount,
        fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.random.RandomDataImpl randomData) {
    ...
    private EmpiricalDistribution(int binCount,
        fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.random.RandomDataGenerator randomData) {
     ...
     *
     * <p>
     * The input file <i>must</i> be an ASCII text file containing one
    ...
    private void fillBinStats(final DataAdapter da) throws IOException {
        ...
        upperBounds[0] = ((double) binStats.get(0)
            .getN()) / (double) sampleStats.getN();
        for (int i = 1; i < binCount - 1; i++) {
            upperBounds[i] = upperBounds[i - 1] + ((double) binStats.get(i)
                .getN()) / (double) sampleStats.getN();
        }
