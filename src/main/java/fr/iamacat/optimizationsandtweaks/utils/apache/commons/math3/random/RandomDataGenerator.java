...
package fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.random;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.BetaDistribution;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.BinomialDistribution;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.CauchyDistribution;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.ChiSquaredDistribution;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.ExponentialDistribution;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.FDistribution;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.GammaDistribution;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.HypergeometricDistribution;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.PascalDistribution;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.PoissonDistribution;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.TDistribution;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.UniformIntegerDistribution;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.WeibullDistribution;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.ZipfDistribution;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.exception.MathInternalError;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.exception.NotANumberException;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.exception.NotFiniteNumberException;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.exception.NumberIsTooLargeException;
...
public class RandomDataGenerator implements RandomData, Serializable {
    ...
    public int nextHypergeometric(int populationSize, int numberOfSuccesses, int sampleSize)
        ...
        return new HypergeometricDistribution(getRandomGenerator(), populationSize, numberOfSuccesses, sampleSize)
            .sample();
    }
