...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.IntegerDistribution;
...
public class RandomDataImpl implements RandomData, Serializable {
    ...
    /**
     * Generates a random value from the
     * {@link fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.BinomialDistribution Binomial
     * Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the
     * {@link fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.ChiSquaredDistribution ChiSquare
     * Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the
     * {@link fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.FDistribution F Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the
     * {@link fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.HypergeometricDistribution
    ...
    /**
     * Generates a random value from the
     * {@link fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.TDistribution T Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the
     * {@link fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.WeibullDistribution Weibull
     * Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
