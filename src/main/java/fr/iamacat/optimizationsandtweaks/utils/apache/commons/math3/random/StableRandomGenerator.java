 ...
 * James E. Gentle, Wolfgang H&auml;rdle, Yuichi Mori.
 * </p>
 *
 * @since 3.0
 */
public class StableRandomGenerator implements NormalizedRandomGenerator {
     ...
     */
    public StableRandomGenerator(final RandomGenerator generator, final double alpha, final double beta)
    ...
    public double nextNormalizedDouble() {
        ...
        if (beta == 0d) {
            ...
            if (alpha == 1d) {
                ...
                x = FastMath.pow(omega * FastMath.cos((1 - alpha) * phi), 1d / alpha - 1d) * FastMath.sin(alpha * phi)
            ...
            if (FastMath.abs(alpha - 1d) > 1e-8) {
                ...
                x = 2d / FastMath.PI
                    * (betaPhi * FastMath.tan(phi) - beta * FastMath.log(FastMath.PI / 2d * omega * cosPhi / betaPhi));
