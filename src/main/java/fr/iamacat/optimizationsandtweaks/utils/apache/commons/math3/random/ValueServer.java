...
public class ValueServer {
    ...
    public void computeDistribution(int binCount) throws NullArgumentException, IOException, ZeroException {
        ...
        mu = empiricalDistribution.getSampleStats()
            .getMean();
        sigma = empiricalDistribution.getSampleStats()
     ...
     *
     * <p>
     * The values file <i>must</i> be an ASCII text file containing one
     ...
     * <code>IllegalStateException</code> will be thrown</li>
     * </ul>
     * </p>
     *
    ...
    private double getNextDigest() throws MathIllegalStateException {
        if ((empiricalDistribution == null) || (empiricalDistribution.getBinStats()
            .size() == 0)) {
