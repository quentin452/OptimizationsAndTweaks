...
package fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.stat.clustering;
...
public class KMeansPlusPlusClusterer<T extends Clusterable<T>> {
     ...
     */
    public List<Cluster<T>> cluster(final Collection<T> points, final int k, int numTrials, int maxIterationsPerTrial)
    ...
    private T getFarthestPoint(final Collection<Cluster<T>> clusters) throws ConvergenceException {
        ...
        for (final Cluster<T> cluster : clusters) {
            ...
            for (int i = 0; i < points.size(); ++i) {
                final double distance = points.get(i)
                    .distanceFrom(center);
