 ...
 */
package fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.stat.descriptive.rank;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.exception.MathUnsupportedOperationException;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.stat.descriptive.AbstractUnivariateStatistic;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.stat.ranking.NaNStrategy;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.util.FastMath;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.util.KthSelector;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.util.MedianOf3PivotingStrategy;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.util.PivotingStrategyInterface;
...
public class Percentile extends AbstractUnivariateStatistic implements Serializable {
    ...
    protected Percentile(final double quantile, final EstimationType estimationType, final NaNStrategy nanStrategy,
        final KthSelector kthSelector) throws MathIllegalArgumentException {
     ...
     */
    private static double[] replaceAndSlice(final double[] values, final int begin, final int length,
     ...
     */
    private static double[] removeAndSlice(final double[] values, final int begin, final int length,
     ...
     * <pre>
     *
     * Percentile customized = new Percentile(quantile).withEstimationType(estimationType)
    ...
    public enum EstimationType {
        ...
        LEGACY("Legacy Apache Commons Math") {
            ...
            protected double index(final double p, final int length) {
                ...
                return Double.compare(p, minLimit) == 0 ? 0
                    : Double.compare(p, maxLimit) == 0 ? length : p * (length + 1);
            }
        },
        /**
        ...
        R_1("R-1") {
             ...
             */
            @Override
            protected double estimate(final double[] values, final int[] pivotsHeap, final double pos, final int length,
        ...
        R_5("R-5") {
            ...
            protected double index(final double p, final int length) {
                ...
                return Double.compare(p, minLimit) < 0 ? 0
                    : Double.compare(p, maxLimit) >= 0 ? length : length * p + 0.5;
            }
        },
        /**
        ...
        R_6("R-6") {
            ...
            protected double index(final double p, final int length) {
                ...
                return Double.compare(p, minLimit) < 0 ? 0
                    : Double.compare(p, maxLimit) >= 0 ? length : (length + 1) * p;
            }
        },
        ...
        R_7("R-7") {
            ...
            protected double index(final double p, final int length) {
                ...
                final double maxLimit = 1d;
                return Double.compare(p, minLimit) == 0 ? 0
                    : Double.compare(p, maxLimit) == 0 ? length : 1 + (length - 1) * p;
            }
        ...
        R_8("R-8") {
            ...
            protected double index(final double p, final int length) {
                ...
                return Double.compare(p, minLimit) < 0 ? 0
                    : Double.compare(p, maxLimit) >= 0 ? length : (length + 1d / 3) * p + 1d / 3;
            }
        },
        ...
        R_9("R-9") {
            ...
            protected double index(final double p, final int length) {
                ...
                return Double.compare(p, minLimit) < 0 ? 0
                    : Double.compare(p, maxLimit) >= 0 ? length : (length + 0.25) * p + 3d / 8;
            }
         ...
         */
        protected double estimate(final double[] work, final int[] pivotsHeap, final double pos, final int length,
            final KthSelector selector) {
