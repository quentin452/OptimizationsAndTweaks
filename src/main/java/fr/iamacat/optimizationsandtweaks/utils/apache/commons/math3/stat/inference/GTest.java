...
public class GTest {
    ...
    public double g(final double[] expected, final long[] observed)
        ...
        double sum = 0d;
        for (int i = 0; i < observed.length; i++) {
            final double dev = rescale ? FastMath.log((double) observed[i] / (ratio * expected[i]))
     ...
     *                                      p-value.
     */
    public double gTest(final double[] expected, final long[] observed) throws NotPositiveException,
     ...
     *                                      p-value.
     */
    public double gTestIntrinsic(final double[] expected, final long[] observed) throws NotPositiveException,
        NotStrictlyPositiveException, DimensionMismatchException, MaxCountExceededException {
     ...
     *
     * <p>
     * See {@link #gTest(double[], long[])} for details
     ...
     * </p>
     * <p>
     * See {@link #gDataSetsComparison(long[], long[])} for details
     ...
     */
    public boolean gTestDataSetsComparison(final long[] observed1, final long[] observed2, final double alpha)
