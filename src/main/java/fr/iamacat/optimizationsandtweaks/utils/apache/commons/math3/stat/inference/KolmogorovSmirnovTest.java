...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.EnumeratedRealDistribution;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.RealDistribution;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.UniformRealDistribution;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.exception.TooManyIterationsException;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.fraction.BigFractionField;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.fraction.FractionConversionException;
...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.random.JDKRandomGenerator;
...
public class KolmogorovSmirnovTest {
    ...
    public double pelzGood(double d, int n) {
        ...
        for (k = 0; k < MAXIMUM_PARTIAL_SUM_COUNT; k++) {
            kTerm = k + 0.5;
            kTerm2 = kTerm * kTerm;
            increment = (z6Term + z4Term
                + MathUtils.PI_SQUARED * (z4Term - z2Term) * kTerm2
        ...
        for (k = 0; k < MAXIMUM_PARTIAL_SUM_COUNT; k++) {
            ...
            increment = (pi6 * kTerm6 * (5 - 30 * z2) + pi4 * kTerm4 * (-60 * z2 + 212 * z4)
                + MathUtils.PI_SQUARED * kTerm2 * (135 * z4 - 96 * z6)
                - 30 * z6
                - 90 * z8) * FastMath.exp(-MathUtils.PI_SQUARED * kTerm2 / twoZ2);
            sum += increment;
            if (FastMath.abs(increment) < PG_SUM_RELATIVE_ERROR * FastMath.abs(sum)) {
                break;
            }
     ...
     */
    static void fillBooleanArrayRandomlyWithFixedNumberTrueValues(final boolean[] b, final int numberOfTrueValues,
