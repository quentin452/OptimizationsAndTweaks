 ...
 * the {@link fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.stat.inference.TTest}.
 * </p>
 * <p>
 * Uses the {@link fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.FDistribution
...
public class OneWayAnova {
     ...
     * {@link fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.distribution.FDistribution
     ...
     * @since 3.2
     */
    public double anovaPValue(final Collection<SummaryStatistics> categoryData, final boolean allowOneElementData)
        throws NullArgumentException, DimensionMismatchException, ConvergenceException, MaxCountExceededException {
    ...
    private AnovaStats anovaStats(final Collection<double[]> categoryData)
        ...
        final Collection<SummaryStatistics> categoryDataSummaryStatistics = new ArrayList<SummaryStatistics>(
            categoryData.size());
     ...
     * @throws MaxCountExceededException  if the maximum number of iterations is exceeded
     */
    public boolean anovaTest(final Collection<double[]> categoryData, final double alpha) throws NullArgumentException,
     ...
     *                                    at least two values
     */
    private AnovaStats anovaStats(final Collection<SummaryStatistics> categoryData, final boolean allowOneElementData)
        throws NullArgumentException, DimensionMismatchException {
