...
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.stat.ranking.NaturalRanking;
import fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.stat.ranking.TiesStrategy;
...
public class WilcoxonSignedRankTest {
     ...
     *                                    is exceeded
     */
    public double wilcoxonSignedRankTest(final double[] x, final double[] y, final boolean exactPValue)
        throws NullArgumentException, NoDataException, DimensionMismatchException, NumberIsTooLargeException,
