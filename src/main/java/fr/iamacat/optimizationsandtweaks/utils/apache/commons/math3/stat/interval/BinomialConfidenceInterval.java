 ...
 */
package fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.stat.interval;
...
public interface BinomialConfidenceInterval {
    ...
    ConfidenceInterval createInterval(int numberOfTrials, int numberOfSuccesses, double confidenceLevel)
        throws NotStrictlyPositiveException, NotPositiveException, NumberIsTooLargeException, OutOfRangeException;
