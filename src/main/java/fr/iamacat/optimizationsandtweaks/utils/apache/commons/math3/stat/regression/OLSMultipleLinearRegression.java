 ...
 */
package fr.iamacat.optimizationsandtweaks.utils.apache.commons.math3.stat.regression;
...
public class OLSMultipleLinearRegression extends AbstractMultipleLinearRegression {
     ...
     *
     * <p>
     * If the model has no intercept term, <code>0</code> is used for the
     ...
     * </p>
     * <p>
     * Uses QR decomposition to reduce (X<sup>T</sup>X)<sup>-1</sup>
    ...
    protected RealMatrix calculateBetaVariance() {
        ...
        RealMatrix Raug = qr.getR()
            .getSubMatrix(0, p - 1, 0, p - 1);
        RealMatrix Rinv = new LUDecomposition(Raug).getSolver()
            .getInverse();
