...
public class ChunkIOProvider2 implements AsynchronousExecutor.CallBackProvider<QueuedChunk2, net.minecraft.world.chunk.Chunk, Runnable, RuntimeException> {
    private final AtomicInteger threadNumber = new AtomicInteger(1);

    // async stuff
    public net.minecraft.world.chunk.Chunk callStage1(QueuedChunk2 queuedChunk) throws RuntimeException {
    ...
    // sync stuff
    public void callStage2(QueuedChunk2 queuedChunk, net.minecraft.world.chunk.Chunk chunk) throws RuntimeException {
        if(chunk == null) {
    ...
    public void callStage3(QueuedChunk2 queuedChunk, net.minecraft.world.chunk.Chunk chunk, Runnable runnable) throws RuntimeException {
        runnable.run();
    }
