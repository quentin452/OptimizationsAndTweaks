...
public class PathFinder2 {
    ...
    public PathFinder2(IBlockAccess p_i2137_1_, boolean p_i2137_2_, boolean p_i2137_3_, boolean p_i2137_4_,
        boolean p_i2137_5_) {
     ...
     */
    public PathEntity2 createEntityPathTo(Entity p_75856_1_, Entity p_75856_2_, float p_75856_3_) {
        return this
            .createEntityPathTo(p_75856_1_, p_75856_2_.posX, p_75856_2_.boundingBox.minY, p_75856_2_.posZ, p_75856_3_);
    }
    ...
    private PathEntity2 createEntityPathTo(Entity p_75857_1_, double p_75857_2_, double p_75857_4_, double p_75857_6_,
        ...
        PathPoint2 pathpoint1 = new PathPoint2(
            ...
            MathHelper.floor_float(p_75857_1_.width + 1.0F));
        PathEntity2 pathentity = this.addToPath(p_75857_1_, pathpoint2, pathpoint, pathpoint1, p_75857_8_);
     ...
     */
    private int findPathOptions(Entity p_75860_1_, PathPoint2 p_75860_2_, PathPoint2 p_75860_3_, PathPoint2 p_75860_4_,
        float p_75860_5_) {
        int i = 0;
        byte b0 = 0;
    ...
    private PathPoint2 getSafePoint(Entity p_75858_1_, int p_75858_2_, int p_75858_3_, int p_75858_4_,
        PathPoint2 p_75858_5_, int p_75858_6_) {
    ...
    public static int func_82565_a(Entity p_82565_0_, int p_82565_1_, int p_82565_2_, int p_82565_3_,
        PathPoint2 p_82565_4_, boolean p_82565_5_, boolean p_82565_6_, boolean p_82565_7_) {
        boolean flag3 = false;
