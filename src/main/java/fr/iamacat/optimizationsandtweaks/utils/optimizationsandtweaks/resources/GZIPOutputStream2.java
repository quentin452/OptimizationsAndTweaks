package fr.iamacat.optimizationsandtweaks.utils.optimizationsandtweaks.resources;
...
public class GZIPOutputStream2 extends DeflaterOutputStream {
     ...
     */
    public GZIPOutputStream2(OutputStream out, int size) throws IOException {
        this(out, size, false);
    }
     ...
     * @since 1.7
     */
    public GZIPOutputStream2(OutputStream out, int size, boolean syncFlush) throws IOException {
     ...
     * @since 1.7
     */
    public GZIPOutputStream2(OutputStream out, boolean syncFlush) throws IOException {
