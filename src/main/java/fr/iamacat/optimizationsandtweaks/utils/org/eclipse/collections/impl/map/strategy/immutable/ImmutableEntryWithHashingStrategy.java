...
package fr.iamacat.optimizationsandtweaks.utils.org.eclipse.collections.impl.map.strategy.immutable;
...
public final class ImmutableEntryWithHashingStrategy<K, V> extends AbstractImmutableEntry<K, V>
{
    ...
    /**
     * Indicates whether an object equals this entry, following the behavior specified in {@link Entry#equals(Object)}.
     */
    @Override
    ...
    /**
     * Return this entry's hash code, following the behavior specified in {@link Entry#hashCode()}.
     */
    @Override
    public int hashCode()
    {
