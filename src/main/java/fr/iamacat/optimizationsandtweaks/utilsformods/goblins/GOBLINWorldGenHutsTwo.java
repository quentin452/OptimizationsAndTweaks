...
public class GOBLINWorldGenHutsTwo {
    ...
    public static boolean canGenerateHuts(World world, int i, int j, int k) {
        if (!world.blockExists(i, j, k) || !world.blockExists(i + 12, j, k + 12)
            || !world.blockExists(i + 12, j, k)
            || !world.blockExists(i, j, k + 12)) {
            return false;
        }
    ...
    static {
        goblinStandardChest = new WeightedRandomChestContent[] {
            ...
            new WeightedRandomChestContent(Items.cooked_beef, 0, 1, 3, 10),
            ...
            new WeightedRandomChestContent(mod_Goblins.bomb, 0, 1, 4, 10),
            new WeightedRandomChestContent(Items.iron_ingot, 0, 1, 5, 10),
            new WeightedRandomChestContent(Items.gold_ingot, 0, 1, 5, 5),
            new WeightedRandomChestContent(Item.getItemFromBlock(Blocks.log), 0, 4, 10, 10) };
        goblinRiderChest = new WeightedRandomChestContent[] { new WeightedRandomChestContent(Items.bread, 0, 3, 6, 9),
            new WeightedRandomChestContent(Items.cooked_beef, 0, 3, 6, 9),
            new WeightedRandomChestContent(Items.cooked_porkchop, 0, 3, 6, 9),
            new WeightedRandomChestContent(Items.bucket, 0, 1, 1, 9),
            new WeightedRandomChestContent(Items.iron_ingot, 0, 1, 5, 9),
            new WeightedRandomChestContent(Items.gold_ingot, 0, 1, 5, 4),
            new WeightedRandomChestContent(Item.getItemFromBlock(Blocks.log), 0, 4, 10, 9),
            new WeightedRandomChestContent(Item.getItemFromBlock(Blocks.skull), 0, 1, 2, 9),
            new WeightedRandomChestContent(Items.saddle, 0, 1, 1, 10),
            new WeightedRandomChestContent(Item.getItemFromBlock(Blocks.wool), 0, 10, 20, 10) };
        goblinMinerChest = new WeightedRandomChestContent[] { new WeightedRandomChestContent(Items.bread, 0, 1, 1, 10),
            new WeightedRandomChestContent(Items.cooked_beef, 0, 1, 3, 10),
            new WeightedRandomChestContent(Items.bucket, 0, 1, 1, 10),
            new WeightedRandomChestContent(Items.iron_ingot, 0, 3, 8, 10),
            new WeightedRandomChestContent(Items.redstone, 0, 3, 8, 10),
            new WeightedRandomChestContent(Items.gold_ingot, 0, 3, 8, 5),
            new WeightedRandomChestContent(Items.diamond, 0, 1, 1, 1),
            new WeightedRandomChestContent(Items.coal, 0, 7, 10, 5),
    ...
    protected static void generateRightHouse(World world, Random rand, int i, int j, int k) {
        ...
        if (tileentitychest != null) {
            ...
            WeightedRandomChestContent
                .generateChestContents(rand, goblinStandardChest, tileentitychest, rand.nextInt(3) + 7);
        }
